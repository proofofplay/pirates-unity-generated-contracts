...
using PirateNationContracts.EnergySystem_Implementation.ContractDefinition;

namespace PirateNationContracts.EnergySystem_Implementation
{
    public partial class EnergysystemImplementationService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, EnergysystemImplementationDeployment energysystemImplementationDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<EnergysystemImplementationDeployment>().SendRequestAndWaitForReceiptAsync(energysystemImplementationDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, EnergysystemImplementationDeployment energysystemImplementationDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<EnergysystemImplementationDeployment>().SendRequestAsync(energysystemImplementationDeployment);
        }

        public static async Task<EnergysystemImplementationService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, EnergysystemImplementationDeployment energysystemImplementationDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, energysystemImplementationDeployment, cancellationTokenSource);
            return new EnergysystemImplementationService(web3, receipt.ContractAddress);
        }
        ...
        public EnergysystemImplementationService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
