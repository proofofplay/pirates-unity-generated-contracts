...
using PirateNationContracts.PopForwarder_Implementation.ContractDefinition;

namespace PirateNationContracts.PopForwarder_Implementation
{
    public partial class PopforwarderImplementationService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, PopforwarderImplementationDeployment popforwarderImplementationDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<PopforwarderImplementationDeployment>().SendRequestAndWaitForReceiptAsync(popforwarderImplementationDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, PopforwarderImplementationDeployment popforwarderImplementationDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<PopforwarderImplementationDeployment>().SendRequestAsync(popforwarderImplementationDeployment);
        }

        public static async Task<PopforwarderImplementationService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, PopforwarderImplementationDeployment popforwarderImplementationDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, popforwarderImplementationDeployment, cancellationTokenSource);
            return new PopforwarderImplementationService(web3, receipt.ContractAddress);
        }
        ...
        public PopforwarderImplementationService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
