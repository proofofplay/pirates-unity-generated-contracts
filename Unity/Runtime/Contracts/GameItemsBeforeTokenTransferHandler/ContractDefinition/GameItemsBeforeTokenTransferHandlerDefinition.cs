...
namespace PirateNationContracts.GameItemsBeforeTokenTransferHandler.ContractDefinition
{


    public partial class GameItemsBeforeTokenTransferHandlerDeployment : GameItemsBeforeTokenTransferHandlerDeploymentBase
    {
        public GameItemsBeforeTokenTransferHandlerDeployment() : base(BYTECODE) { }
        public GameItemsBeforeTokenTransferHandlerDeployment(string byteCode) : base(byteCode) { }
    }

    public class GameItemsBeforeTokenTransferHandlerDeploymentBase : ContractDeploymentMessage
    {
        ...
        public GameItemsBeforeTokenTransferHandlerDeploymentBase() : base(BYTECODE) { }
        public GameItemsBeforeTokenTransferHandlerDeploymentBase(string byteCode) : base(byteCode) { }
