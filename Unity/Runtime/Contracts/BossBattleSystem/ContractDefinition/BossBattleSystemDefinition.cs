...
namespace PirateNationContracts.BossBattleSystem.ContractDefinition
{
    ...
    public partial class BossBattleSystemDeployment : BossBattleSystemDeploymentBase
    {
        public BossBattleSystemDeployment() : base(BYTECODE) { }
        public BossBattleSystemDeployment(string byteCode) : base(byteCode) { }
    }

    public class BossBattleSystemDeploymentBase : ContractDeploymentMessage
    {
        ...
        public BossBattleSystemDeploymentBase() : base(BYTECODE) { }
        public BossBattleSystemDeploymentBase(string byteCode) : base(byteCode) { }
    ...
    public partial class BossEntityToFinalBlowFunction : BossEntityToFinalBlowFunctionBase { }

    [Function("bossEntityToFinalBlow", typeof(BossEntityToFinalBlowOutputDTO))]
    public class BossEntityToFinalBlowFunctionBase : FunctionMessage
    {
        [Parameter("uint256", "", 1)]
        public virtual BigInteger ReturnValue1 { get; set; }
    }

    public partial class EndBattleFunction : EndBattleFunctionBase { }

    [Function("endBattle")]
    public class EndBattleFunctionBase : FunctionMessage
    {
        [Parameter("tuple", "params", 1)]
        public virtual EndBattleParams Params { get; set; }
    }

    public partial class EndBattleMockFunction : EndBattleMockFunctionBase { }
    ...
    public class GetActiveBattleFunctionBase : FunctionMessage
    {
    ...
    [Function("getBattle", typeof(GetBattleOutputDTO))]
    public class GetBattleFunctionBase : FunctionMessage
    {
        [Parameter("uint256", "battleEntity", 1)]
        public virtual BigInteger BattleEntity { get; set; }
    }

    public partial class GetCurrentBattleIdFunction : GetCurrentBattleIdFunctionBase { }

    [Function("getCurrentBattleId", "uint256")]
    public class GetCurrentBattleIdFunctionBase : FunctionMessage
    {
    ...
    public partial class GetShipCooldownFunction : GetShipCooldownFunctionBase { }

    [Function("getShipCooldown", "uint32")]
    public class GetShipCooldownFunctionBase : FunctionMessage
    {
    ...
    public class RewindBattleTimelimitFunctionBase : FunctionMessage
    {
        [Parameter("uint256", "battleEntity", 1)]
        public virtual BigInteger BattleEntity { get; set; }
    ...
    public partial class RewindShipCooldownFunction : RewindShipCooldownFunctionBase { }

    [Function("rewindShipCooldown")]
    public class RewindShipCooldownFunctionBase : FunctionMessage
    {
        [Parameter("uint256", "shipEntity", 1)]
        public virtual BigInteger ShipEntity { get; set; }
        [Parameter("uint32", "rewindTime", 2)]
    ...
    public partial class SetFullValidationFlagFunction : SetFullValidationFlagFunctionBase { }

    [Function("setFullValidationFlag")]
    public class SetFullValidationFlagFunctionBase : FunctionMessage
    {
        [Parameter("bool", "flag", 1)]
    ...
    public partial class StartBattleFunction : StartBattleFunctionBase { }

    [Function("startBattle", "uint256")]
    public class StartBattleFunctionBase : FunctionMessage
    {
        [Parameter("tuple", "params", 1)]
        public virtual StartBattleParams Params { get; set; }
    }
    ...
    public partial class UseFullValidationFlagFunction : UseFullValidationFlagFunctionBase { }

    [Function("useFullValidationFlag", "bool")]
    public class UseFullValidationFlagFunctionBase : FunctionMessage
    {
    ...
    public partial class BattleEndedEventDTO : BattleEndedEventDTOBase { }

    [Event("BattleEnded")]
    public class BattleEndedEventDTOBase : IEventDTO
    {
        [Parameter("uint256", "battleEntity", 1, true )]
        public virtual BigInteger BattleEntity { get; set; }
    }

    public partial class BattlePendingEventDTO : BattlePendingEventDTOBase { }

    [Event("BattlePending")]
    public class BattlePendingEventDTOBase : IEventDTO
    {
        [Parameter("uint256", "battleEntity", 1, true )]
        public virtual BigInteger BattleEntity { get; set; }
        [Parameter("uint256", "attackerEntity", 2, true )]
        public virtual BigInteger AttackerEntity { get; set; }
        [Parameter("uint256", "defenderEntity", 3, true )]
        public virtual BigInteger DefenderEntity { get; set; }
        [Parameter("uint256[]", "attackerOverloads", 4, false )]
        public virtual List<BigInteger> AttackerOverloads { get; set; }
        [Parameter("uint256[]", "defenderOverloads", 5, false )]
    ...
    public class BattleResultsEventDTOBase : IEventDTO
    {
        ...
        public virtual string Account { get; set; }
        [Parameter("uint256", "shipEntity", 2, true )]
        public virtual BigInteger ShipEntity { get; set; }
        [Parameter("uint256", "bossEntity", 3, true )]
        public virtual BigInteger BossEntity { get; set; }
        [Parameter("uint256", "battleEntity", 4, false )]
        public virtual BigInteger BattleEntity { get; set; }
        [Parameter("uint256", "newShipHealth", 5, false )]
        public virtual BigInteger NewShipHealth { get; set; }
        [Parameter("uint256", "newBossHealth", 6, false )]
        public virtual BigInteger NewBossHealth { get; set; }
        [Parameter("uint256", "damageDealt", 7, false )]
    ...
    [Error("ActiveBattleInProgress")]
    public class ActiveBattleInProgressErrorBase : IErrorDTO
    {
        [Parameter("uint256", "battleEntity", 1)]
        public virtual BigInteger BattleEntity { get; set; }
    }
    ...
    public partial class NotImplementedError : NotImplementedErrorBase { }

    [Error("NotImplemented")]
    public class NotImplementedErrorBase : IErrorDTO
    {
    ...
    [FunctionOutput]
    public class BossEntityToFinalBlowOutputDTOBase : IFunctionOutputDTO 
    {
        [Parameter("uint256", "shipEntity", 1)]
        public virtual BigInteger ShipEntity { get; set; }
    ...
    [FunctionOutput]
    public class GetActiveBattleOutputDTOBase : IFunctionOutputDTO 
    {
        [Parameter("tuple", "", 1)]
    ...
    public partial class GetBattleOutputDTO : GetBattleOutputDTOBase { }

    [FunctionOutput]
    public class GetBattleOutputDTOBase : IFunctionOutputDTO 
    {
        [Parameter("tuple", "", 1)]
        public virtual Battle ReturnValue1 { get; set; }
    }

    public partial class GetCurrentBattleIdOutputDTO : GetCurrentBattleIdOutputDTOBase { }

    [FunctionOutput]
    public class GetCurrentBattleIdOutputDTOBase : IFunctionOutputDTO 
    {
        [Parameter("uint256", "", 1)]
        public virtual BigInteger ReturnValue1 { get; set; }
    }
    ...
    public partial class GetShipCooldownOutputDTO : GetShipCooldownOutputDTOBase { }

    [FunctionOutput]
    public class GetShipCooldownOutputDTOBase : IFunctionOutputDTO 
    {
        [Parameter("uint32", "", 1)]
        public virtual uint ReturnValue1 { get; set; }
    }
    ...
    public partial class UseFullValidationFlagOutputDTO : UseFullValidationFlagOutputDTOBase { }

    [FunctionOutput]
    public class UseFullValidationFlagOutputDTOBase : IFunctionOutputDTO 
    {
        [Parameter("bool", "", 1)]
        public virtual bool ReturnValue1 { get; set; }
    }
