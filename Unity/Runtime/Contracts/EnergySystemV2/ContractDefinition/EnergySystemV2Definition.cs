...
namespace PirateNationContracts.EnergySystemV2.ContractDefinition
{


    public partial class EnergySystemV2Deployment : EnergySystemV2DeploymentBase
    {
        public EnergySystemV2Deployment() : base(BYTECODE) { }
        public EnergySystemV2Deployment(string byteCode) : base(byteCode) { }
    }

    public class EnergySystemV2DeploymentBase : ContractDeploymentMessage
    {
        ...
        public EnergySystemV2DeploymentBase() : base(BYTECODE) { }
        public EnergySystemV2DeploymentBase(string byteCode) : base(byteCode) { }
