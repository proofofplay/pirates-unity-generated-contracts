...
using PirateNationContracts.GameItemsTokenURIHandler.ContractDefinition;

namespace PirateNationContracts.GameItemsTokenURIHandler
{
    public partial class GameItemsTokenURIHandlerService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, GameItemsTokenURIHandlerDeployment gameItemsTokenURIHandlerDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<GameItemsTokenURIHandlerDeployment>().SendRequestAndWaitForReceiptAsync(gameItemsTokenURIHandlerDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, GameItemsTokenURIHandlerDeployment gameItemsTokenURIHandlerDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<GameItemsTokenURIHandlerDeployment>().SendRequestAsync(gameItemsTokenURIHandlerDeployment);
        }

        public static async Task<GameItemsTokenURIHandlerService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, GameItemsTokenURIHandlerDeployment gameItemsTokenURIHandlerDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, gameItemsTokenURIHandlerDeployment, cancellationTokenSource);
            return new GameItemsTokenURIHandlerService(web3, receipt.ContractAddress);
        }
        ...
        public GameItemsTokenURIHandlerService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
