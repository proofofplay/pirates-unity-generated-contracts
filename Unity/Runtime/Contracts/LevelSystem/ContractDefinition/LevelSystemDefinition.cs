...
namespace PirateNationContracts.LevelSystem.ContractDefinition
{


    public partial class LevelSystemDeployment : LevelSystemDeploymentBase
    {
        public LevelSystemDeployment() : base(BYTECODE) { }
        public LevelSystemDeployment(string byteCode) : base(byteCode) { }
    }

    public class LevelSystemDeploymentBase : ContractDeploymentMessage
    {
        ...
        public LevelSystemDeploymentBase() : base(BYTECODE) { }
        public LevelSystemDeploymentBase(string byteCode) : base(byteCode) { }
