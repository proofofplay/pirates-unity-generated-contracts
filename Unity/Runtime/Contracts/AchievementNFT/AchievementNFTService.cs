...
using PirateNationContracts.AchievementNFT.ContractDefinition;

namespace PirateNationContracts.AchievementNFT
{
    public partial class AchievementNFTService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, AchievementNFTDeployment achievementNFTDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<AchievementNFTDeployment>().SendRequestAndWaitForReceiptAsync(achievementNFTDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, AchievementNFTDeployment achievementNFTDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<AchievementNFTDeployment>().SendRequestAsync(achievementNFTDeployment);
        }

        public static async Task<AchievementNFTService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, AchievementNFTDeployment achievementNFTDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, achievementNFTDeployment, cancellationTokenSource);
            return new AchievementNFTService(web3, receipt.ContractAddress);
        }
        ...
        public AchievementNFTService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
