...
using PirateNationContracts.ARC_CaptainLevel_Proxy.ContractDefinition;

namespace PirateNationContracts.ARC_CaptainLevel_Proxy
{
    public partial class ArcCaptainlevelProxyService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, ArcCaptainlevelProxyDeployment arcCaptainlevelProxyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<ArcCaptainlevelProxyDeployment>().SendRequestAndWaitForReceiptAsync(arcCaptainlevelProxyDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, ArcCaptainlevelProxyDeployment arcCaptainlevelProxyDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<ArcCaptainlevelProxyDeployment>().SendRequestAsync(arcCaptainlevelProxyDeployment);
        }

        public static async Task<ArcCaptainlevelProxyService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, ArcCaptainlevelProxyDeployment arcCaptainlevelProxyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, arcCaptainlevelProxyDeployment, cancellationTokenSource);
            return new ArcCaptainlevelProxyService(web3, receipt.ContractAddress);
        }
        ...
        public ArcCaptainlevelProxyService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
