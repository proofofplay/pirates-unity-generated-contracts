...
namespace PirateNationContracts.GameItemsTokenURIHandler.ContractDefinition
{
    ...
    public partial class GameItemsTokenURIHandlerDeployment : GameItemsTokenURIHandlerDeploymentBase
    {
        public GameItemsTokenURIHandlerDeployment() : base(BYTECODE) { }
        public GameItemsTokenURIHandlerDeployment(string byteCode) : base(byteCode) { }
    }

    public class GameItemsTokenURIHandlerDeploymentBase : ContractDeploymentMessage
    {
        ...
        public GameItemsTokenURIHandlerDeploymentBase() : base(BYTECODE) { }
        public GameItemsTokenURIHandlerDeploymentBase(string byteCode) : base(byteCode) { }
