...
using PirateNationContracts.CooldownSystem_Proxy.ContractDefinition;

namespace PirateNationContracts.CooldownSystem_Proxy
{
    public partial class CooldownsystemProxyService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, CooldownsystemProxyDeployment cooldownsystemProxyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<CooldownsystemProxyDeployment>().SendRequestAndWaitForReceiptAsync(cooldownsystemProxyDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, CooldownsystemProxyDeployment cooldownsystemProxyDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<CooldownsystemProxyDeployment>().SendRequestAsync(cooldownsystemProxyDeployment);
        }

        public static async Task<CooldownsystemProxyService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, CooldownsystemProxyDeployment cooldownsystemProxyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, cooldownsystemProxyDeployment, cancellationTokenSource);
            return new CooldownsystemProxyService(web3, receipt.ContractAddress);
        }
        ...
        public CooldownsystemProxyService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
