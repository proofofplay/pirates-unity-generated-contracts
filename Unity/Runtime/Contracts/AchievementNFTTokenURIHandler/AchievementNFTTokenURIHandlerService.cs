...
using PirateNationContracts.AchievementNFTTokenURIHandler.ContractDefinition;

namespace PirateNationContracts.AchievementNFTTokenURIHandler
{
    public partial class AchievementNFTTokenURIHandlerService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, AchievementNFTTokenURIHandlerDeployment achievementNFTTokenURIHandlerDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<AchievementNFTTokenURIHandlerDeployment>().SendRequestAndWaitForReceiptAsync(achievementNFTTokenURIHandlerDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, AchievementNFTTokenURIHandlerDeployment achievementNFTTokenURIHandlerDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<AchievementNFTTokenURIHandlerDeployment>().SendRequestAsync(achievementNFTTokenURIHandlerDeployment);
        }

        public static async Task<AchievementNFTTokenURIHandlerService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, AchievementNFTTokenURIHandlerDeployment achievementNFTTokenURIHandlerDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, achievementNFTTokenURIHandlerDeployment, cancellationTokenSource);
            return new AchievementNFTTokenURIHandlerService(web3, receipt.ContractAddress);
        }
        ...
        public AchievementNFTTokenURIHandlerService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
