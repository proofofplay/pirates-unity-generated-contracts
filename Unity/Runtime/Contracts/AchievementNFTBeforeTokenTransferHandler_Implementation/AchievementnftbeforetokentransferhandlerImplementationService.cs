...
using PirateNationContracts.AchievementNFTBeforeTokenTransferHandler_Implementation.ContractDefinition;

namespace PirateNationContracts.AchievementNFTBeforeTokenTransferHandler_Implementation
{
    public partial class AchievementnftbeforetokentransferhandlerImplementationService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, AchievementnftbeforetokentransferhandlerImplementationDeployment achievementnftbeforetokentransferhandlerImplementationDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<AchievementnftbeforetokentransferhandlerImplementationDeployment>().SendRequestAndWaitForReceiptAsync(achievementnftbeforetokentransferhandlerImplementationDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, AchievementnftbeforetokentransferhandlerImplementationDeployment achievementnftbeforetokentransferhandlerImplementationDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<AchievementnftbeforetokentransferhandlerImplementationDeployment>().SendRequestAsync(achievementnftbeforetokentransferhandlerImplementationDeployment);
        }

        public static async Task<AchievementnftbeforetokentransferhandlerImplementationService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, AchievementnftbeforetokentransferhandlerImplementationDeployment achievementnftbeforetokentransferhandlerImplementationDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, achievementnftbeforetokentransferhandlerImplementationDeployment, cancellationTokenSource);
            return new AchievementnftbeforetokentransferhandlerImplementationService(web3, receipt.ContractAddress);
        }
        ...
        public AchievementnftbeforetokentransferhandlerImplementationService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
