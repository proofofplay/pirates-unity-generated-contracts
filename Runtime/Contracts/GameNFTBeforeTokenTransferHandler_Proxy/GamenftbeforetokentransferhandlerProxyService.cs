...
using PirateNationContracts.GameNFTBeforeTokenTransferHandler_Proxy.ContractDefinition;

namespace PirateNationContracts.GameNFTBeforeTokenTransferHandler_Proxy
{
    public partial class GamenftbeforetokentransferhandlerProxyService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, GamenftbeforetokentransferhandlerProxyDeployment gamenftbeforetokentransferhandlerProxyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<GamenftbeforetokentransferhandlerProxyDeployment>().SendRequestAndWaitForReceiptAsync(gamenftbeforetokentransferhandlerProxyDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, GamenftbeforetokentransferhandlerProxyDeployment gamenftbeforetokentransferhandlerProxyDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<GamenftbeforetokentransferhandlerProxyDeployment>().SendRequestAsync(gamenftbeforetokentransferhandlerProxyDeployment);
        }

        public static async Task<GamenftbeforetokentransferhandlerProxyService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, GamenftbeforetokentransferhandlerProxyDeployment gamenftbeforetokentransferhandlerProxyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, gamenftbeforetokentransferhandlerProxyDeployment, cancellationTokenSource);
            return new GamenftbeforetokentransferhandlerProxyService(web3, receipt.ContractAddress);
        }
        ...
        public GamenftbeforetokentransferhandlerProxyService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
