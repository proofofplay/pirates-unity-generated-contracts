...
namespace PirateNationContracts.GameNFTBeforeTokenTransferHandler.ContractDefinition
{


    public partial class GameNFTBeforeTokenTransferHandlerDeployment : GameNFTBeforeTokenTransferHandlerDeploymentBase
    {
        public GameNFTBeforeTokenTransferHandlerDeployment() : base(BYTECODE) { }
        public GameNFTBeforeTokenTransferHandlerDeployment(string byteCode) : base(byteCode) { }
    }

    public class GameNFTBeforeTokenTransferHandlerDeploymentBase : ContractDeploymentMessage
    {
        ...
        public GameNFTBeforeTokenTransferHandlerDeploymentBase() : base(BYTECODE) { }
        public GameNFTBeforeTokenTransferHandlerDeploymentBase(string byteCode) : base(byteCode) { }
