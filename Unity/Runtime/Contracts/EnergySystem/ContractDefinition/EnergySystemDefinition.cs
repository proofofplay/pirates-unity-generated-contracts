...
namespace PirateNationContracts.EnergySystem.ContractDefinition
{


    public partial class EnergySystemDeployment : EnergySystemDeploymentBase
    {
        public EnergySystemDeployment() : base(BYTECODE) { }
        public EnergySystemDeployment(string byteCode) : base(byteCode) { }
    }

    public class EnergySystemDeploymentBase : ContractDeploymentMessage
    {
        ...
        public EnergySystemDeploymentBase() : base(BYTECODE) { }
        public EnergySystemDeploymentBase(string byteCode) : base(byteCode) { }
