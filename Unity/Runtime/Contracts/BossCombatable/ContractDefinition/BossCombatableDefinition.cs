...
namespace PirateNationContracts.BossCombatable.ContractDefinition
{
    ...
    public partial class BossCombatableDeployment : BossCombatableDeploymentBase
    {
        public BossCombatableDeployment() : base(BYTECODE) { }
        public BossCombatableDeployment(string byteCode) : base(byteCode) { }
    }

    public class BossCombatableDeploymentBase : ContractDeploymentMessage
    {
        ...
        public BossCombatableDeploymentBase() : base(BYTECODE) { }
        public BossCombatableDeploymentBase(string byteCode) : base(byteCode) { }
