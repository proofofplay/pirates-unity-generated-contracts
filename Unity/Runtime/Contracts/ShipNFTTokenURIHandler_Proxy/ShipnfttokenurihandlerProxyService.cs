...
using PirateNationContracts.ShipNFTTokenURIHandler_Proxy.ContractDefinition;

namespace PirateNationContracts.ShipNFTTokenURIHandler_Proxy
{
    public partial class ShipnfttokenurihandlerProxyService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, ShipnfttokenurihandlerProxyDeployment shipnfttokenurihandlerProxyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<ShipnfttokenurihandlerProxyDeployment>().SendRequestAndWaitForReceiptAsync(shipnfttokenurihandlerProxyDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, ShipnfttokenurihandlerProxyDeployment shipnfttokenurihandlerProxyDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<ShipnfttokenurihandlerProxyDeployment>().SendRequestAsync(shipnfttokenurihandlerProxyDeployment);
        }

        public static async Task<ShipnfttokenurihandlerProxyService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, ShipnfttokenurihandlerProxyDeployment shipnfttokenurihandlerProxyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, shipnfttokenurihandlerProxyDeployment, cancellationTokenSource);
            return new ShipnfttokenurihandlerProxyService(web3, receipt.ContractAddress);
        }
        ...
        public ShipnfttokenurihandlerProxyService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
