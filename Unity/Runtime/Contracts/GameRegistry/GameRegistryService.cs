...
using PirateNationContracts.GameRegistry.ContractDefinition;

namespace PirateNationContracts.GameRegistry
{
    public partial class GameRegistryService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, GameRegistryDeployment gameRegistryDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<GameRegistryDeployment>().SendRequestAndWaitForReceiptAsync(gameRegistryDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, GameRegistryDeployment gameRegistryDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<GameRegistryDeployment>().SendRequestAsync(gameRegistryDeployment);
        }

        public static async Task<GameRegistryService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, GameRegistryDeployment gameRegistryDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, gameRegistryDeployment, cancellationTokenSource);
            return new GameRegistryService(web3, receipt.ContractAddress);
        }
        ...
        public GameRegistryService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
