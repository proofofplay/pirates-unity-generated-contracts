...
namespace PirateNationContracts.CooldownSystem.ContractDefinition
{


    public partial class CooldownSystemDeployment : CooldownSystemDeploymentBase
    {
        public CooldownSystemDeployment() : base(BYTECODE) { }
        public CooldownSystemDeployment(string byteCode) : base(byteCode) { }
    }

    public class CooldownSystemDeploymentBase : ContractDeploymentMessage
    {
        ...
        public CooldownSystemDeploymentBase() : base(BYTECODE) { }
        public CooldownSystemDeploymentBase(string byteCode) : base(byteCode) { }
