...
using PirateNationContracts.LevelSystem_Proxy.ContractDefinition;

namespace PirateNationContracts.LevelSystem_Proxy
{
    public partial class LevelsystemProxyService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, LevelsystemProxyDeployment levelsystemProxyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<LevelsystemProxyDeployment>().SendRequestAndWaitForReceiptAsync(levelsystemProxyDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, LevelsystemProxyDeployment levelsystemProxyDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<LevelsystemProxyDeployment>().SendRequestAsync(levelsystemProxyDeployment);
        }

        public static async Task<LevelsystemProxyService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, LevelsystemProxyDeployment levelsystemProxyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, levelsystemProxyDeployment, cancellationTokenSource);
            return new LevelsystemProxyService(web3, receipt.ContractAddress);
        }
        ...
        public LevelsystemProxyService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
