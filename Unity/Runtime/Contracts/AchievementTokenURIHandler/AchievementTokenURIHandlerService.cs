...
using PirateNationContracts.AchievementTokenURIHandler.ContractDefinition;

namespace PirateNationContracts.AchievementTokenURIHandler
{
    public partial class AchievementTokenURIHandlerService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, AchievementTokenURIHandlerDeployment achievementTokenURIHandlerDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<AchievementTokenURIHandlerDeployment>().SendRequestAndWaitForReceiptAsync(achievementTokenURIHandlerDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, AchievementTokenURIHandlerDeployment achievementTokenURIHandlerDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<AchievementTokenURIHandlerDeployment>().SendRequestAsync(achievementTokenURIHandlerDeployment);
        }

        public static async Task<AchievementTokenURIHandlerService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, AchievementTokenURIHandlerDeployment achievementTokenURIHandlerDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, achievementTokenURIHandlerDeployment, cancellationTokenSource);
            return new AchievementTokenURIHandlerService(web3, receipt.ContractAddress);
        }
        ...
        public AchievementTokenURIHandlerService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
