...
using PirateNationContracts.GameNFTTokenURIHandler.ContractDefinition;

namespace PirateNationContracts.GameNFTTokenURIHandler
{
    public partial class GameNFTTokenURIHandlerService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, GameNFTTokenURIHandlerDeployment gameNFTTokenURIHandlerDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<GameNFTTokenURIHandlerDeployment>().SendRequestAndWaitForReceiptAsync(gameNFTTokenURIHandlerDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, GameNFTTokenURIHandlerDeployment gameNFTTokenURIHandlerDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<GameNFTTokenURIHandlerDeployment>().SendRequestAsync(gameNFTTokenURIHandlerDeployment);
        }

        public static async Task<GameNFTTokenURIHandlerService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, GameNFTTokenURIHandlerDeployment gameNFTTokenURIHandlerDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, gameNFTTokenURIHandlerDeployment, cancellationTokenSource);
            return new GameNFTTokenURIHandlerService(web3, receipt.ContractAddress);
        }
        ...
        public GameNFTTokenURIHandlerService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
