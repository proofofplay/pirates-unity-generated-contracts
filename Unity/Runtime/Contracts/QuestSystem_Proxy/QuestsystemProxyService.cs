...
using PirateNationContracts.QuestSystem_Proxy.ContractDefinition;

namespace PirateNationContracts.QuestSystem_Proxy
{
    public partial class QuestsystemProxyService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, QuestsystemProxyDeployment questsystemProxyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<QuestsystemProxyDeployment>().SendRequestAndWaitForReceiptAsync(questsystemProxyDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, QuestsystemProxyDeployment questsystemProxyDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<QuestsystemProxyDeployment>().SendRequestAsync(questsystemProxyDeployment);
        }

        public static async Task<QuestsystemProxyService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, QuestsystemProxyDeployment questsystemProxyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, questsystemProxyDeployment, cancellationTokenSource);
            return new QuestsystemProxyService(web3, receipt.ContractAddress);
        }
        ...
        public QuestsystemProxyService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
