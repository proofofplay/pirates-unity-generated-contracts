...
using PirateNationContracts.BossBattleSystem_Proxy.ContractDefinition;

namespace PirateNationContracts.BossBattleSystem_Proxy
{
    public partial class BossbattlesystemProxyService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, BossbattlesystemProxyDeployment bossbattlesystemProxyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<BossbattlesystemProxyDeployment>().SendRequestAndWaitForReceiptAsync(bossbattlesystemProxyDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, BossbattlesystemProxyDeployment bossbattlesystemProxyDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<BossbattlesystemProxyDeployment>().SendRequestAsync(bossbattlesystemProxyDeployment);
        }

        public static async Task<BossbattlesystemProxyService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, BossbattlesystemProxyDeployment bossbattlesystemProxyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, bossbattlesystemProxyDeployment, cancellationTokenSource);
            return new BossbattlesystemProxyService(web3, receipt.ContractAddress);
        }
        ...
        public BossbattlesystemProxyService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
