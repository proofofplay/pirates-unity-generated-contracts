...
using PirateNationContracts.LootSystem_Proxy.ContractDefinition;

namespace PirateNationContracts.LootSystem_Proxy
{
    public partial class LootsystemProxyService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, LootsystemProxyDeployment lootsystemProxyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<LootsystemProxyDeployment>().SendRequestAndWaitForReceiptAsync(lootsystemProxyDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, LootsystemProxyDeployment lootsystemProxyDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<LootsystemProxyDeployment>().SendRequestAsync(lootsystemProxyDeployment);
        }

        public static async Task<LootsystemProxyService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, LootsystemProxyDeployment lootsystemProxyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, lootsystemProxyDeployment, cancellationTokenSource);
            return new LootsystemProxyService(web3, receipt.ContractAddress);
        }
        ...
        public LootsystemProxyService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
