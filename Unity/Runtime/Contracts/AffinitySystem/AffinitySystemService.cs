...
using PirateNationContracts.AffinitySystem.ContractDefinition;

namespace PirateNationContracts.AffinitySystem
{
    public partial class AffinitySystemService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, AffinitySystemDeployment affinitySystemDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<AffinitySystemDeployment>().SendRequestAndWaitForReceiptAsync(affinitySystemDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, AffinitySystemDeployment affinitySystemDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<AffinitySystemDeployment>().SendRequestAsync(affinitySystemDeployment);
        }

        public static async Task<AffinitySystemService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, AffinitySystemDeployment affinitySystemDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, affinitySystemDeployment, cancellationTokenSource);
            return new AffinitySystemService(web3, receipt.ContractAddress);
        }
        ...
        public AffinitySystemService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
