...
using PirateNationContracts.TokenTemplateSystem_Implementation.ContractDefinition;

namespace PirateNationContracts.TokenTemplateSystem_Implementation
{
    public partial class TokentemplatesystemImplementationService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, TokentemplatesystemImplementationDeployment tokentemplatesystemImplementationDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<TokentemplatesystemImplementationDeployment>().SendRequestAndWaitForReceiptAsync(tokentemplatesystemImplementationDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, TokentemplatesystemImplementationDeployment tokentemplatesystemImplementationDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<TokentemplatesystemImplementationDeployment>().SendRequestAsync(tokentemplatesystemImplementationDeployment);
        }

        public static async Task<TokentemplatesystemImplementationService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, TokentemplatesystemImplementationDeployment tokentemplatesystemImplementationDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, tokentemplatesystemImplementationDeployment, cancellationTokenSource);
            return new TokentemplatesystemImplementationService(web3, receipt.ContractAddress);
        }
        ...
        public TokentemplatesystemImplementationService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
