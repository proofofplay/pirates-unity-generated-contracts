...
using PirateNationContracts.HoldingSystem_Proxy.ContractDefinition;

namespace PirateNationContracts.HoldingSystem_Proxy
{
    public partial class HoldingsystemProxyService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, HoldingsystemProxyDeployment holdingsystemProxyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<HoldingsystemProxyDeployment>().SendRequestAndWaitForReceiptAsync(holdingsystemProxyDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, HoldingsystemProxyDeployment holdingsystemProxyDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<HoldingsystemProxyDeployment>().SendRequestAsync(holdingsystemProxyDeployment);
        }

        public static async Task<HoldingsystemProxyService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, HoldingsystemProxyDeployment holdingsystemProxyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, holdingsystemProxyDeployment, cancellationTokenSource);
            return new HoldingsystemProxyService(web3, receipt.ContractAddress);
        }
        ...
        public HoldingsystemProxyService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
