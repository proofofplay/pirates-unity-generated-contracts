...
namespace PirateNationContracts.BossSpawn.ContractDefinition
{


    public partial class BossSpawnDeployment : BossSpawnDeploymentBase
    {
        public BossSpawnDeployment() : base(BYTECODE) { }
        public BossSpawnDeployment(string byteCode) : base(byteCode) { }
    }

    public class BossSpawnDeploymentBase : ContractDeploymentMessage
    {
        ...
        public BossSpawnDeploymentBase() : base(BYTECODE) { }
        public BossSpawnDeploymentBase(string byteCode) : base(byteCode) { }
