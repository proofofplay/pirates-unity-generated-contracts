...
namespace PirateNationContracts.AchievementSystem.ContractDefinition
{


    public partial class AchievementSystemDeployment : AchievementSystemDeploymentBase
    {
        public AchievementSystemDeployment() : base(BYTECODE) { }
        public AchievementSystemDeployment(string byteCode) : base(byteCode) { }
    }

    public class AchievementSystemDeploymentBase : ContractDeploymentMessage
    {
        ...
        public AchievementSystemDeploymentBase() : base(BYTECODE) { }
        public AchievementSystemDeploymentBase(string byteCode) : base(byteCode) { }
