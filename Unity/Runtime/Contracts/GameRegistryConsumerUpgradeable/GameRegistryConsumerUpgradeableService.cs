...
using SimpleStorage.GameRegistryConsumerUpgradeable.ContractDefinition;

namespace SimpleStorage.GameRegistryConsumerUpgradeable
{
    public partial class GameRegistryConsumerUpgradeableService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, GameRegistryConsumerUpgradeableDeployment gameRegistryConsumerUpgradeableDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<GameRegistryConsumerUpgradeableDeployment>().SendRequestAndWaitForReceiptAsync(gameRegistryConsumerUpgradeableDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, GameRegistryConsumerUpgradeableDeployment gameRegistryConsumerUpgradeableDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<GameRegistryConsumerUpgradeableDeployment>().SendRequestAsync(gameRegistryConsumerUpgradeableDeployment);
        }

        public static async Task<GameRegistryConsumerUpgradeableService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, GameRegistryConsumerUpgradeableDeployment gameRegistryConsumerUpgradeableDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, gameRegistryConsumerUpgradeableDeployment, cancellationTokenSource);
            return new GameRegistryConsumerUpgradeableService(web3, receipt.ContractAddress);
        }
        ...
        public GameRegistryConsumerUpgradeableService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
