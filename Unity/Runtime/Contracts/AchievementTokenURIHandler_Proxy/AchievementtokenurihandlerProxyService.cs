...
using PirateNationContracts.AchievementTokenURIHandler_Proxy.ContractDefinition;

namespace PirateNationContracts.AchievementTokenURIHandler_Proxy
{
    public partial class AchievementtokenurihandlerProxyService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, AchievementtokenurihandlerProxyDeployment achievementtokenurihandlerProxyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<AchievementtokenurihandlerProxyDeployment>().SendRequestAndWaitForReceiptAsync(achievementtokenurihandlerProxyDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, AchievementtokenurihandlerProxyDeployment achievementtokenurihandlerProxyDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<AchievementtokenurihandlerProxyDeployment>().SendRequestAsync(achievementtokenurihandlerProxyDeployment);
        }

        public static async Task<AchievementtokenurihandlerProxyService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, AchievementtokenurihandlerProxyDeployment achievementtokenurihandlerProxyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, achievementtokenurihandlerProxyDeployment, cancellationTokenSource);
            return new AchievementtokenurihandlerProxyService(web3, receipt.ContractAddress);
        }
        ...
        public AchievementtokenurihandlerProxyService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
