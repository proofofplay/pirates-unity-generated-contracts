...
using PirateNationContracts.BossSpawn_Implementation.ContractDefinition;

namespace PirateNationContracts.BossSpawn_Implementation
{
    public partial class BossspawnImplementationService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, BossspawnImplementationDeployment bossspawnImplementationDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<BossspawnImplementationDeployment>().SendRequestAndWaitForReceiptAsync(bossspawnImplementationDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, BossspawnImplementationDeployment bossspawnImplementationDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<BossspawnImplementationDeployment>().SendRequestAsync(bossspawnImplementationDeployment);
        }

        public static async Task<BossspawnImplementationService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, BossspawnImplementationDeployment bossspawnImplementationDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, bossspawnImplementationDeployment, cancellationTokenSource);
            return new BossspawnImplementationService(web3, receipt.ContractAddress);
        }
        ...
        public BossspawnImplementationService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
        ...
        public Task<string> SpawnBossRequestAsync(SpawnBossFunction spawnBossFunction)
        {
             return ContractHandler.SendRequestAsync(spawnBossFunction);
        }

        public Task<TransactionReceipt> SpawnBossRequestAndWaitForReceiptAsync(SpawnBossFunction spawnBossFunction, CancellationTokenSource cancellationToken = null)
        {
             return ContractHandler.SendRequestAndWaitForReceiptAsync(spawnBossFunction, cancellationToken);
        }

        public Task<string> SpawnBossRequestAsync(BigInteger templateId)
        {
            var spawnBossFunction = new SpawnBossFunction();
                spawnBossFunction.TemplateId = templateId;
            
             return ContractHandler.SendRequestAsync(spawnBossFunction);
        }

        public Task<TransactionReceipt> SpawnBossRequestAndWaitForReceiptAsync(BigInteger templateId, CancellationTokenSource cancellationToken = null)
        {
            var spawnBossFunction = new SpawnBossFunction();
                spawnBossFunction.TemplateId = templateId;
