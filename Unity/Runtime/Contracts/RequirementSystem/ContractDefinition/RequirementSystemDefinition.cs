...
namespace PirateNationContracts.RequirementSystem.ContractDefinition
{


    public partial class RequirementSystemDeployment : RequirementSystemDeploymentBase
    {
        public RequirementSystemDeployment() : base(BYTECODE) { }
        public RequirementSystemDeployment(string byteCode) : base(byteCode) { }
    }

    public class RequirementSystemDeploymentBase : ContractDeploymentMessage
    {
        ...
        public RequirementSystemDeploymentBase() : base(BYTECODE) { }
        public RequirementSystemDeploymentBase(string byteCode) : base(byteCode) { }
