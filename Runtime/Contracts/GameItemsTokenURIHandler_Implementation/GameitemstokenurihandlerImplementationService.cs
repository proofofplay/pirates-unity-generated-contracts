...
using PirateNationContracts.GameItemsTokenURIHandler_Implementation.ContractDefinition;

namespace PirateNationContracts.GameItemsTokenURIHandler_Implementation
{
    public partial class GameitemstokenurihandlerImplementationService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, GameitemstokenurihandlerImplementationDeployment gameitemstokenurihandlerImplementationDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<GameitemstokenurihandlerImplementationDeployment>().SendRequestAndWaitForReceiptAsync(gameitemstokenurihandlerImplementationDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, GameitemstokenurihandlerImplementationDeployment gameitemstokenurihandlerImplementationDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<GameitemstokenurihandlerImplementationDeployment>().SendRequestAsync(gameitemstokenurihandlerImplementationDeployment);
        }

        public static async Task<GameitemstokenurihandlerImplementationService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, GameitemstokenurihandlerImplementationDeployment gameitemstokenurihandlerImplementationDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, gameitemstokenurihandlerImplementationDeployment, cancellationTokenSource);
            return new GameitemstokenurihandlerImplementationService(web3, receipt.ContractAddress);
        }
        ...
        public GameitemstokenurihandlerImplementationService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
