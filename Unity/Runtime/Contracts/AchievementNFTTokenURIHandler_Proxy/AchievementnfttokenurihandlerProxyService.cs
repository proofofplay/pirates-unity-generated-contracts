...
using PirateNationContracts.AchievementNFTTokenURIHandler_Proxy.ContractDefinition;

namespace PirateNationContracts.AchievementNFTTokenURIHandler_Proxy
{
    public partial class AchievementnfttokenurihandlerProxyService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, AchievementnfttokenurihandlerProxyDeployment achievementnfttokenurihandlerProxyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<AchievementnfttokenurihandlerProxyDeployment>().SendRequestAndWaitForReceiptAsync(achievementnfttokenurihandlerProxyDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, AchievementnfttokenurihandlerProxyDeployment achievementnfttokenurihandlerProxyDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<AchievementnfttokenurihandlerProxyDeployment>().SendRequestAsync(achievementnfttokenurihandlerProxyDeployment);
        }

        public static async Task<AchievementnfttokenurihandlerProxyService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, AchievementnfttokenurihandlerProxyDeployment achievementnfttokenurihandlerProxyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, achievementnfttokenurihandlerProxyDeployment, cancellationTokenSource);
            return new AchievementnfttokenurihandlerProxyService(web3, receipt.ContractAddress);
        }
        ...
        public AchievementnfttokenurihandlerProxyService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
