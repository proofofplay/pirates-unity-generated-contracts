...
namespace PirateNationContracts.ShipSystemMock.ContractDefinition
{


    public partial class ShipSystemMockDeployment : ShipSystemMockDeploymentBase
    {
        public ShipSystemMockDeployment() : base(BYTECODE) { }
        public ShipSystemMockDeployment(string byteCode) : base(byteCode) { }
    }

    public class ShipSystemMockDeploymentBase : ContractDeploymentMessage
    {
        ...
        public ShipSystemMockDeploymentBase() : base(BYTECODE) { }
        public ShipSystemMockDeploymentBase(string byteCode) : base(byteCode) { }
