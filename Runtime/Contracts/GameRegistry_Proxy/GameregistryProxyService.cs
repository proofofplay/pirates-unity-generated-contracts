...
using PirateNationContracts.GameRegistry_Proxy.ContractDefinition;

namespace PirateNationContracts.GameRegistry_Proxy
{
    public partial class GameregistryProxyService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, GameregistryProxyDeployment gameregistryProxyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<GameregistryProxyDeployment>().SendRequestAndWaitForReceiptAsync(gameregistryProxyDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, GameregistryProxyDeployment gameregistryProxyDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<GameregistryProxyDeployment>().SendRequestAsync(gameregistryProxyDeployment);
        }

        public static async Task<GameregistryProxyService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, GameregistryProxyDeployment gameregistryProxyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, gameregistryProxyDeployment, cancellationTokenSource);
            return new GameregistryProxyService(web3, receipt.ContractAddress);
        }
        ...
        public GameregistryProxyService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
