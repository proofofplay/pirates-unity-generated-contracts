...
namespace PirateNationContracts.ShipSystem.ContractDefinition
{
    ...
    public partial class ShipSystemDeployment : ShipSystemDeploymentBase
    {
        public ShipSystemDeployment() : base(BYTECODE) { }
        public ShipSystemDeployment(string byteCode) : base(byteCode) { }
    }

    public class ShipSystemDeploymentBase : ContractDeploymentMessage
    {
        ...
        public ShipSystemDeploymentBase() : base(BYTECODE) { }
        public ShipSystemDeploymentBase(string byteCode) : base(byteCode) { }
