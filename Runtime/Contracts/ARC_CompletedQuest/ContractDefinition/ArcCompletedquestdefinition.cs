...
namespace PirateNationContracts.ARC_CompletedQuest.ContractDefinition
{


    public partial class ArcCompletedquestDeployment : ArcCompletedquestDeploymentBase
    {
        public ArcCompletedquestDeployment() : base(BYTECODE) { }
        public ArcCompletedquestDeployment(string byteCode) : base(byteCode) { }
    }

    public class ArcCompletedquestDeploymentBase : ContractDeploymentMessage
    {
        ...
        public ArcCompletedquestDeploymentBase() : base(BYTECODE) { }
        public ArcCompletedquestDeploymentBase(string byteCode) : base(byteCode) { }
