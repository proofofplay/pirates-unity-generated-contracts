...
using PirateNationContracts.ARC_CaptainLevel_Implementation.ContractDefinition;

namespace PirateNationContracts.ARC_CaptainLevel_Implementation
{
    public partial class ArcCaptainlevelImplementationService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, ArcCaptainlevelImplementationDeployment arcCaptainlevelImplementationDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<ArcCaptainlevelImplementationDeployment>().SendRequestAndWaitForReceiptAsync(arcCaptainlevelImplementationDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, ArcCaptainlevelImplementationDeployment arcCaptainlevelImplementationDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<ArcCaptainlevelImplementationDeployment>().SendRequestAsync(arcCaptainlevelImplementationDeployment);
        }

        public static async Task<ArcCaptainlevelImplementationService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, ArcCaptainlevelImplementationDeployment arcCaptainlevelImplementationDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, arcCaptainlevelImplementationDeployment, cancellationTokenSource);
            return new ArcCaptainlevelImplementationService(web3, receipt.ContractAddress);
        }
        ...
        public ArcCaptainlevelImplementationService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
