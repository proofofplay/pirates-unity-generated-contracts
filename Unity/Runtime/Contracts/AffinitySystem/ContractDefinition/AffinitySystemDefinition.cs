...
namespace PirateNationContracts.AffinitySystem.ContractDefinition
{


    public partial class AffinitySystemDeployment : AffinitySystemDeploymentBase
    {
        public AffinitySystemDeployment() : base(BYTECODE) { }
        public AffinitySystemDeployment(string byteCode) : base(byteCode) { }
    }

    public class AffinitySystemDeploymentBase : ContractDeploymentMessage
    {
        ...
        public AffinitySystemDeploymentBase() : base(BYTECODE) { }
        public AffinitySystemDeploymentBase(string byteCode) : base(byteCode) { }
