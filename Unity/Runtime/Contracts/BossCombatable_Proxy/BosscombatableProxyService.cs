...
using PirateNationContracts.BossCombatable_Proxy.ContractDefinition;

namespace PirateNationContracts.BossCombatable_Proxy
{
    public partial class BosscombatableProxyService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, BosscombatableProxyDeployment bosscombatableProxyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<BosscombatableProxyDeployment>().SendRequestAndWaitForReceiptAsync(bosscombatableProxyDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, BosscombatableProxyDeployment bosscombatableProxyDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<BosscombatableProxyDeployment>().SendRequestAsync(bosscombatableProxyDeployment);
        }

        public static async Task<BosscombatableProxyService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, BosscombatableProxyDeployment bosscombatableProxyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, bosscombatableProxyDeployment, cancellationTokenSource);
            return new BosscombatableProxyService(web3, receipt.ContractAddress);
        }
        ...
        public BosscombatableProxyService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
