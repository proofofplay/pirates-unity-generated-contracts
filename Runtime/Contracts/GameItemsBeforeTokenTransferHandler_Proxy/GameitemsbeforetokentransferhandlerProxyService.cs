...
using PirateNationContracts.GameItemsBeforeTokenTransferHandler_Proxy.ContractDefinition;

namespace PirateNationContracts.GameItemsBeforeTokenTransferHandler_Proxy
{
    public partial class GameitemsbeforetokentransferhandlerProxyService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, GameitemsbeforetokentransferhandlerProxyDeployment gameitemsbeforetokentransferhandlerProxyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<GameitemsbeforetokentransferhandlerProxyDeployment>().SendRequestAndWaitForReceiptAsync(gameitemsbeforetokentransferhandlerProxyDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, GameitemsbeforetokentransferhandlerProxyDeployment gameitemsbeforetokentransferhandlerProxyDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<GameitemsbeforetokentransferhandlerProxyDeployment>().SendRequestAsync(gameitemsbeforetokentransferhandlerProxyDeployment);
        }

        public static async Task<GameitemsbeforetokentransferhandlerProxyService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, GameitemsbeforetokentransferhandlerProxyDeployment gameitemsbeforetokentransferhandlerProxyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, gameitemsbeforetokentransferhandlerProxyDeployment, cancellationTokenSource);
            return new GameitemsbeforetokentransferhandlerProxyService(web3, receipt.ContractAddress);
        }
        ...
        public GameitemsbeforetokentransferhandlerProxyService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
