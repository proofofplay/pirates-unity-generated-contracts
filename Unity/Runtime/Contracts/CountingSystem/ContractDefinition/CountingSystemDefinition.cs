...
namespace PirateNationContracts.CountingSystem.ContractDefinition
{


    public partial class CountingSystemDeployment : CountingSystemDeploymentBase
    {
        public CountingSystemDeployment() : base(BYTECODE) { }
        public CountingSystemDeployment(string byteCode) : base(byteCode) { }
    }

    public class CountingSystemDeploymentBase : ContractDeploymentMessage
    {
        ...
        public CountingSystemDeploymentBase() : base(BYTECODE) { }
        public CountingSystemDeploymentBase(string byteCode) : base(byteCode) { }
