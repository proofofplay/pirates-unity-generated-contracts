...
using PirateNationContracts.TraitsProvider_Implementation.ContractDefinition;

namespace PirateNationContracts.TraitsProvider_Implementation
{
    public partial class TraitsproviderImplementationService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, TraitsproviderImplementationDeployment traitsproviderImplementationDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<TraitsproviderImplementationDeployment>().SendRequestAndWaitForReceiptAsync(traitsproviderImplementationDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, TraitsproviderImplementationDeployment traitsproviderImplementationDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<TraitsproviderImplementationDeployment>().SendRequestAsync(traitsproviderImplementationDeployment);
        }

        public static async Task<TraitsproviderImplementationService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, TraitsproviderImplementationDeployment traitsproviderImplementationDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, traitsproviderImplementationDeployment, cancellationTokenSource);
            return new TraitsproviderImplementationService(web3, receipt.ContractAddress);
        }
        ...
        public TraitsproviderImplementationService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
