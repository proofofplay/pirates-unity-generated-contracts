...
namespace PirateNationContracts.PirateGameV1.ContractDefinition
{


    public partial class PirateGameV1Deployment : PirateGameV1DeploymentBase
    {
        public PirateGameV1Deployment() : base(BYTECODE) { }
        public PirateGameV1Deployment(string byteCode) : base(byteCode) { }
    }

    public class PirateGameV1DeploymentBase : ContractDeploymentMessage
    {
        ...
        public PirateGameV1DeploymentBase() : base(BYTECODE) { }
        public PirateGameV1DeploymentBase(string byteCode) : base(byteCode) { }
    ...
    public partial class GrantXPFunction : GrantXPFunctionBase { }

    [Function("grantXP")]
    public class GrantXPFunctionBase : FunctionMessage
    {
    ...
    public partial class UpgradePirateLevelFunction : UpgradePirateLevelFunctionBase { }

    [Function("upgradePirateLevel")]
    public class UpgradePirateLevelFunctionBase : FunctionMessage
    {
        [Parameter("address", "nftContract", 1)]
        public virtual string NftContract { get; set; }
        [Parameter("uint256", "nftTokenId", 2)]
        public virtual BigInteger NftTokenId { get; set; }
        [Parameter("uint32", "desiredLevel", 3)]
        public virtual uint DesiredLevel { get; set; }
    }
    ...
    public partial class UpgradePirateLevelEventDTO : UpgradePirateLevelEventDTOBase { }

    [Event("UpgradePirateLevel")]
    public class UpgradePirateLevelEventDTOBase : IEventDTO
    {
        [Parameter("address", "tokenContract", 1, true )]
        public virtual string TokenContract { get; set; }
        [Parameter("uint256", "tokenId", 2, true )]
        public virtual BigInteger TokenId { get; set; }
        [Parameter("uint256", "newLevel", 3, false )]
        public virtual BigInteger NewLevel { get; set; }
    }

    public partial class DesiredLevelExceedsMaxLevelError : DesiredLevelExceedsMaxLevelErrorBase { }

    [Error("DesiredLevelExceedsMaxLevel")]
    public class DesiredLevelExceedsMaxLevelErrorBase : IErrorDTO
    {
        [Parameter("uint256", "maxLevel", 1)]
        public virtual BigInteger MaxLevel { get; set; }
        [Parameter("uint256", "desiredLevel", 2)]
        public virtual BigInteger DesiredLevel { get; set; }
    }
