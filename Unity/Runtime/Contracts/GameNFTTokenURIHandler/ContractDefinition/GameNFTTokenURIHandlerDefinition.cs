...
namespace PirateNationContracts.GameNFTTokenURIHandler.ContractDefinition
{


    public partial class GameNFTTokenURIHandlerDeployment : GameNFTTokenURIHandlerDeploymentBase
    {
        public GameNFTTokenURIHandlerDeployment() : base(BYTECODE) { }
        public GameNFTTokenURIHandlerDeployment(string byteCode) : base(byteCode) { }
    }

    public class GameNFTTokenURIHandlerDeploymentBase : ContractDeploymentMessage
    {
        ...
        public GameNFTTokenURIHandlerDeploymentBase() : base(BYTECODE) { }
        public GameNFTTokenURIHandlerDeploymentBase(string byteCode) : base(byteCode) { }
