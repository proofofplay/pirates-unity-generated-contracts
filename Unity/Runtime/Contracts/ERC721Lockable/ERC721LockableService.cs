...
using SimpleStorage.ERC721Lockable.ContractDefinition;

namespace SimpleStorage.ERC721Lockable
{
    public partial class ERC721LockableService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, ERC721LockableDeployment eRC721LockableDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<ERC721LockableDeployment>().SendRequestAndWaitForReceiptAsync(eRC721LockableDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, ERC721LockableDeployment eRC721LockableDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<ERC721LockableDeployment>().SendRequestAsync(eRC721LockableDeployment);
        }

        public static async Task<ERC721LockableService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, ERC721LockableDeployment eRC721LockableDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, eRC721LockableDeployment, cancellationTokenSource);
            return new ERC721LockableService(web3, receipt.ContractAddress);
        }
        ...
        public ERC721LockableService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
