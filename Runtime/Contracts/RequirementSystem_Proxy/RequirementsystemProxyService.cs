...
using PirateNationContracts.RequirementSystem_Proxy.ContractDefinition;

namespace PirateNationContracts.RequirementSystem_Proxy
{
    public partial class RequirementsystemProxyService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, RequirementsystemProxyDeployment requirementsystemProxyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<RequirementsystemProxyDeployment>().SendRequestAndWaitForReceiptAsync(requirementsystemProxyDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, RequirementsystemProxyDeployment requirementsystemProxyDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<RequirementsystemProxyDeployment>().SendRequestAsync(requirementsystemProxyDeployment);
        }

        public static async Task<RequirementsystemProxyService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, RequirementsystemProxyDeployment requirementsystemProxyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, requirementsystemProxyDeployment, cancellationTokenSource);
            return new RequirementsystemProxyService(web3, receipt.ContractAddress);
        }
        ...
        public RequirementsystemProxyService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
