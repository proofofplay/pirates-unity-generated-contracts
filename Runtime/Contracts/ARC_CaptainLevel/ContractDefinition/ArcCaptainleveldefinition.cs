...
namespace PirateNationContracts.ARC_CaptainLevel.ContractDefinition
{


    public partial class ArcCaptainlevelDeployment : ArcCaptainlevelDeploymentBase
    {
        public ArcCaptainlevelDeployment() : base(BYTECODE) { }
        public ArcCaptainlevelDeployment(string byteCode) : base(byteCode) { }
    }

    public class ArcCaptainlevelDeploymentBase : ContractDeploymentMessage
    {
        ...
        public ArcCaptainlevelDeploymentBase() : base(BYTECODE) { }
        public ArcCaptainlevelDeploymentBase(string byteCode) : base(byteCode) { }
