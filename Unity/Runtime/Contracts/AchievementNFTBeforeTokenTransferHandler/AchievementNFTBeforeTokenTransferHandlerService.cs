...
using PirateNationContracts.AchievementNFTBeforeTokenTransferHandler.ContractDefinition;

namespace PirateNationContracts.AchievementNFTBeforeTokenTransferHandler
{
    public partial class AchievementNFTBeforeTokenTransferHandlerService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, AchievementNFTBeforeTokenTransferHandlerDeployment achievementNFTBeforeTokenTransferHandlerDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<AchievementNFTBeforeTokenTransferHandlerDeployment>().SendRequestAndWaitForReceiptAsync(achievementNFTBeforeTokenTransferHandlerDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, AchievementNFTBeforeTokenTransferHandlerDeployment achievementNFTBeforeTokenTransferHandlerDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<AchievementNFTBeforeTokenTransferHandlerDeployment>().SendRequestAsync(achievementNFTBeforeTokenTransferHandlerDeployment);
        }

        public static async Task<AchievementNFTBeforeTokenTransferHandlerService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, AchievementNFTBeforeTokenTransferHandlerDeployment achievementNFTBeforeTokenTransferHandlerDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, achievementNFTBeforeTokenTransferHandlerDeployment, cancellationTokenSource);
            return new AchievementNFTBeforeTokenTransferHandlerService(web3, receipt.ContractAddress);
        }
        ...
        public AchievementNFTBeforeTokenTransferHandlerService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
