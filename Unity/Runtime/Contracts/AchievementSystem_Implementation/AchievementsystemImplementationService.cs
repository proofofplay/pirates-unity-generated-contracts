...
using PirateNationContracts.AchievementSystem_Implementation.ContractDefinition;

namespace PirateNationContracts.AchievementSystem_Implementation
{
    public partial class AchievementsystemImplementationService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, AchievementsystemImplementationDeployment achievementsystemImplementationDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<AchievementsystemImplementationDeployment>().SendRequestAndWaitForReceiptAsync(achievementsystemImplementationDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, AchievementsystemImplementationDeployment achievementsystemImplementationDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<AchievementsystemImplementationDeployment>().SendRequestAsync(achievementsystemImplementationDeployment);
        }

        public static async Task<AchievementsystemImplementationService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, AchievementsystemImplementationDeployment achievementsystemImplementationDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, achievementsystemImplementationDeployment, cancellationTokenSource);
            return new AchievementsystemImplementationService(web3, receipt.ContractAddress);
        }
        ...
        public AchievementsystemImplementationService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
            ContractHandler = web3.Eth.GetContractHandler(contractAddress);
        }

        public Task<BigInteger> AchievementsIssuedQueryAsync(AchievementsIssuedFunction achievementsIssuedFunction, BlockParameter blockParameter = null)
        {
            return ContractHandler.QueryAsync<AchievementsIssuedFunction, BigInteger>(achievementsIssuedFunction, blockParameter);
        }

        
        public Task<BigInteger> AchievementsIssuedQueryAsync(BlockParameter blockParameter = null)
        {
            return ContractHandler.QueryAsync<AchievementsIssuedFunction, BigInteger>(null, blockParameter);
        }
        ...
        public Task<string> GrantAchievementRequestAsync(GrantAchievementFunction grantAchievementFunction)
        {
             return ContractHandler.SendRequestAsync(grantAchievementFunction);
        }

        public Task<TransactionReceipt> GrantAchievementRequestAndWaitForReceiptAsync(GrantAchievementFunction grantAchievementFunction, CancellationTokenSource cancellationToken = null)
        {
             return ContractHandler.SendRequestAndWaitForReceiptAsync(grantAchievementFunction, cancellationToken);
        }

        public Task<string> GrantAchievementRequestAsync(string account, BigInteger templateId)
        {
            var grantAchievementFunction = new GrantAchievementFunction();
                grantAchievementFunction.Account = account;
                grantAchievementFunction.TemplateId = templateId;
            
             return ContractHandler.SendRequestAsync(grantAchievementFunction);
        }

        public Task<TransactionReceipt> GrantAchievementRequestAndWaitForReceiptAsync(string account, BigInteger templateId, CancellationTokenSource cancellationToken = null)
        {
            var grantAchievementFunction = new GrantAchievementFunction();
                grantAchievementFunction.Account = account;
                grantAchievementFunction.TemplateId = templateId;
