...
using PirateNationContracts.ARC_CompletedQuest.ContractDefinition;

namespace PirateNationContracts.ARC_CompletedQuest
{
    public partial class ArcCompletedquestService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, ArcCompletedquestDeployment arcCompletedquestDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<ArcCompletedquestDeployment>().SendRequestAndWaitForReceiptAsync(arcCompletedquestDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, ArcCompletedquestDeployment arcCompletedquestDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<ArcCompletedquestDeployment>().SendRequestAsync(arcCompletedquestDeployment);
        }

        public static async Task<ArcCompletedquestService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, ArcCompletedquestDeployment arcCompletedquestDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, arcCompletedquestDeployment, cancellationTokenSource);
            return new ArcCompletedquestService(web3, receipt.ContractAddress);
        }
        ...
        public ArcCompletedquestService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
