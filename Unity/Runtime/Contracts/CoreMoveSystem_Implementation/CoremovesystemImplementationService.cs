...
using PirateNationContracts.CoreMoveSystem_Implementation.ContractDefinition;

namespace PirateNationContracts.CoreMoveSystem_Implementation
{
    public partial class CoremovesystemImplementationService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, CoremovesystemImplementationDeployment coremovesystemImplementationDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<CoremovesystemImplementationDeployment>().SendRequestAndWaitForReceiptAsync(coremovesystemImplementationDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, CoremovesystemImplementationDeployment coremovesystemImplementationDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<CoremovesystemImplementationDeployment>().SendRequestAsync(coremovesystemImplementationDeployment);
        }

        public static async Task<CoremovesystemImplementationService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, CoremovesystemImplementationDeployment coremovesystemImplementationDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, coremovesystemImplementationDeployment, cancellationTokenSource);
            return new CoremovesystemImplementationService(web3, receipt.ContractAddress);
        }
        ...
        public CoremovesystemImplementationService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
        ...
        public Task<List<BigInteger>> GetCombatModifiersQueryAsync(GetCombatModifiersFunction getCombatModifiersFunction, BlockParameter blockParameter = null)
        {
            return ContractHandler.QueryAsync<GetCombatModifiersFunction, List<BigInteger>>(getCombatModifiersFunction, blockParameter);
        }

        
        public Task<List<BigInteger>> GetCombatModifiersQueryAsync(BigInteger moveId, BlockParameter blockParameter = null)
        {
            var getCombatModifiersFunction = new GetCombatModifiersFunction();
                getCombatModifiersFunction.MoveId = moveId;
