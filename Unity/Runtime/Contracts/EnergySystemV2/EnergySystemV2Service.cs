...
using PirateNationContracts.EnergySystemV2.ContractDefinition;

namespace PirateNationContracts.EnergySystemV2
{
    public partial class EnergySystemV2Service
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, EnergySystemV2Deployment energySystemV2Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<EnergySystemV2Deployment>().SendRequestAndWaitForReceiptAsync(energySystemV2Deployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, EnergySystemV2Deployment energySystemV2Deployment)
        {
            return web3.Eth.GetContractDeploymentHandler<EnergySystemV2Deployment>().SendRequestAsync(energySystemV2Deployment);
        }

        public static async Task<EnergySystemV2Service> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, EnergySystemV2Deployment energySystemV2Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, energySystemV2Deployment, cancellationTokenSource);
            return new EnergySystemV2Service(web3, receipt.ContractAddress);
        }
        ...
        public EnergySystemV2Service(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
