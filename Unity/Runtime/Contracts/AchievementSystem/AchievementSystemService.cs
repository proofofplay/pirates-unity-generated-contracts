...
using PirateNationContracts.AchievementSystem.ContractDefinition;

namespace PirateNationContracts.AchievementSystem
{
    public partial class AchievementSystemService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, AchievementSystemDeployment achievementSystemDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<AchievementSystemDeployment>().SendRequestAndWaitForReceiptAsync(achievementSystemDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, AchievementSystemDeployment achievementSystemDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<AchievementSystemDeployment>().SendRequestAsync(achievementSystemDeployment);
        }

        public static async Task<AchievementSystemService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, AchievementSystemDeployment achievementSystemDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, achievementSystemDeployment, cancellationTokenSource);
            return new AchievementSystemService(web3, receipt.ContractAddress);
        }
        ...
        public AchievementSystemService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
