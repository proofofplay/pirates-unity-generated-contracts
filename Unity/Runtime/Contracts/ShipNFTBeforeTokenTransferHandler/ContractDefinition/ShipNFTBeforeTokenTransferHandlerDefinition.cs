...
namespace PirateNationContracts.ShipNFTBeforeTokenTransferHandler.ContractDefinition
{


    public partial class ShipNFTBeforeTokenTransferHandlerDeployment : ShipNFTBeforeTokenTransferHandlerDeploymentBase
    {
        public ShipNFTBeforeTokenTransferHandlerDeployment() : base(BYTECODE) { }
        public ShipNFTBeforeTokenTransferHandlerDeployment(string byteCode) : base(byteCode) { }
    }

    public class ShipNFTBeforeTokenTransferHandlerDeploymentBase : ContractDeploymentMessage
    {
        ...
        public ShipNFTBeforeTokenTransferHandlerDeploymentBase() : base(BYTECODE) { }
        public ShipNFTBeforeTokenTransferHandlerDeploymentBase(string byteCode) : base(byteCode) { }
