...
using PirateNationContracts.GameNFTTokenURIHandler_Implementation.ContractDefinition;

namespace PirateNationContracts.GameNFTTokenURIHandler_Implementation
{
    public partial class GamenfttokenurihandlerImplementationService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, GamenfttokenurihandlerImplementationDeployment gamenfttokenurihandlerImplementationDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<GamenfttokenurihandlerImplementationDeployment>().SendRequestAndWaitForReceiptAsync(gamenfttokenurihandlerImplementationDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, GamenfttokenurihandlerImplementationDeployment gamenfttokenurihandlerImplementationDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<GamenfttokenurihandlerImplementationDeployment>().SendRequestAsync(gamenfttokenurihandlerImplementationDeployment);
        }

        public static async Task<GamenfttokenurihandlerImplementationService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, GamenfttokenurihandlerImplementationDeployment gamenfttokenurihandlerImplementationDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, gamenfttokenurihandlerImplementationDeployment, cancellationTokenSource);
            return new GamenfttokenurihandlerImplementationService(web3, receipt.ContractAddress);
        }
        ...
        public GamenfttokenurihandlerImplementationService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
