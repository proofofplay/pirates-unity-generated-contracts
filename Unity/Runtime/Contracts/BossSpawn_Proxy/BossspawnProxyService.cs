...
using PirateNationContracts.BossSpawn_Proxy.ContractDefinition;

namespace PirateNationContracts.BossSpawn_Proxy
{
    public partial class BossspawnProxyService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, BossspawnProxyDeployment bossspawnProxyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<BossspawnProxyDeployment>().SendRequestAndWaitForReceiptAsync(bossspawnProxyDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, BossspawnProxyDeployment bossspawnProxyDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<BossspawnProxyDeployment>().SendRequestAsync(bossspawnProxyDeployment);
        }

        public static async Task<BossspawnProxyService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, BossspawnProxyDeployment bossspawnProxyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, bossspawnProxyDeployment, cancellationTokenSource);
            return new BossspawnProxyService(web3, receipt.ContractAddress);
        }
        ...
        public BossspawnProxyService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
