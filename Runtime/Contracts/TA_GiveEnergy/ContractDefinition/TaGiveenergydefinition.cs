...
namespace PirateNationContracts.TA_GiveEnergy.ContractDefinition
{


    public partial class TaGiveenergyDeployment : TaGiveenergyDeploymentBase
    {
        public TaGiveenergyDeployment() : base(BYTECODE) { }
        public TaGiveenergyDeployment(string byteCode) : base(byteCode) { }
    }

    public class TaGiveenergyDeploymentBase : ContractDeploymentMessage
    {
        ...
        public TaGiveenergyDeploymentBase() : base(BYTECODE) { }
        public TaGiveenergyDeploymentBase(string byteCode) : base(byteCode) { }
