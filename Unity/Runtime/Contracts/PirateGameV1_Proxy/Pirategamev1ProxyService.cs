...
using PirateNationContracts.PirateGameV1_Proxy.ContractDefinition;

namespace PirateNationContracts.PirateGameV1_Proxy
{
    public partial class Pirategamev1ProxyService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, Pirategamev1ProxyDeployment pirategamev1ProxyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<Pirategamev1ProxyDeployment>().SendRequestAndWaitForReceiptAsync(pirategamev1ProxyDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, Pirategamev1ProxyDeployment pirategamev1ProxyDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<Pirategamev1ProxyDeployment>().SendRequestAsync(pirategamev1ProxyDeployment);
        }

        public static async Task<Pirategamev1ProxyService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, Pirategamev1ProxyDeployment pirategamev1ProxyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, pirategamev1ProxyDeployment, cancellationTokenSource);
            return new Pirategamev1ProxyService(web3, receipt.ContractAddress);
        }
        ...
        public Pirategamev1ProxyService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
