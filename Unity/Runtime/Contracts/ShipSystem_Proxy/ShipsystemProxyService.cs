...
using PirateNationContracts.ShipSystem_Proxy.ContractDefinition;

namespace PirateNationContracts.ShipSystem_Proxy
{
    public partial class ShipsystemProxyService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, ShipsystemProxyDeployment shipsystemProxyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<ShipsystemProxyDeployment>().SendRequestAndWaitForReceiptAsync(shipsystemProxyDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, ShipsystemProxyDeployment shipsystemProxyDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<ShipsystemProxyDeployment>().SendRequestAsync(shipsystemProxyDeployment);
        }

        public static async Task<ShipsystemProxyService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, ShipsystemProxyDeployment shipsystemProxyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, shipsystemProxyDeployment, cancellationTokenSource);
            return new ShipsystemProxyService(web3, receipt.ContractAddress);
        }
        ...
        public ShipsystemProxyService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
