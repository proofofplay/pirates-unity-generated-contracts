...
namespace PirateNationContracts.AchievementNFTTokenURIHandler.ContractDefinition
{


    public partial class AchievementNFTTokenURIHandlerDeployment : AchievementNFTTokenURIHandlerDeploymentBase
    {
        public AchievementNFTTokenURIHandlerDeployment() : base(BYTECODE) { }
        public AchievementNFTTokenURIHandlerDeployment(string byteCode) : base(byteCode) { }
    }

    public class AchievementNFTTokenURIHandlerDeploymentBase : ContractDeploymentMessage
    {
        ...
        public AchievementNFTTokenURIHandlerDeploymentBase() : base(BYTECODE) { }
        public AchievementNFTTokenURIHandlerDeploymentBase(string byteCode) : base(byteCode) { }
