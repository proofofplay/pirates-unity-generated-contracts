...
using PirateNationContracts.GameNFTBeforeTokenTransferHandler.ContractDefinition;

namespace PirateNationContracts.GameNFTBeforeTokenTransferHandler
{
    public partial class GameNFTBeforeTokenTransferHandlerService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, GameNFTBeforeTokenTransferHandlerDeployment gameNFTBeforeTokenTransferHandlerDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<GameNFTBeforeTokenTransferHandlerDeployment>().SendRequestAndWaitForReceiptAsync(gameNFTBeforeTokenTransferHandlerDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, GameNFTBeforeTokenTransferHandlerDeployment gameNFTBeforeTokenTransferHandlerDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<GameNFTBeforeTokenTransferHandlerDeployment>().SendRequestAsync(gameNFTBeforeTokenTransferHandlerDeployment);
        }

        public static async Task<GameNFTBeforeTokenTransferHandlerService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, GameNFTBeforeTokenTransferHandlerDeployment gameNFTBeforeTokenTransferHandlerDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, gameNFTBeforeTokenTransferHandlerDeployment, cancellationTokenSource);
            return new GameNFTBeforeTokenTransferHandlerService(web3, receipt.ContractAddress);
        }
        ...
        public GameNFTBeforeTokenTransferHandlerService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
