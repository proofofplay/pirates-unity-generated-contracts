...
namespace PirateNationContracts.LootSystem.ContractDefinition
{
    ...
    public partial class LootSystemDeployment : LootSystemDeploymentBase
    {
        public LootSystemDeployment() : base(BYTECODE) { }
        public LootSystemDeployment(string byteCode) : base(byteCode) { }
    }

    public class LootSystemDeploymentBase : ContractDeploymentMessage
    {
        ...
        public LootSystemDeploymentBase() : base(BYTECODE) { }
        public LootSystemDeploymentBase(string byteCode) : base(byteCode) { }
