...
using PirateNationContracts.LockingSystem_Implementation.ContractDefinition;

namespace PirateNationContracts.LockingSystem_Implementation
{
    public partial class LockingsystemImplementationService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, LockingsystemImplementationDeployment lockingsystemImplementationDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<LockingsystemImplementationDeployment>().SendRequestAndWaitForReceiptAsync(lockingsystemImplementationDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, LockingsystemImplementationDeployment lockingsystemImplementationDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<LockingsystemImplementationDeployment>().SendRequestAsync(lockingsystemImplementationDeployment);
        }

        public static async Task<LockingsystemImplementationService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, LockingsystemImplementationDeployment lockingsystemImplementationDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, lockingsystemImplementationDeployment, cancellationTokenSource);
            return new LockingsystemImplementationService(web3, receipt.ContractAddress);
        }
        ...
        public LockingsystemImplementationService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
