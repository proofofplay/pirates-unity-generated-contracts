...
using PirateNationContracts.ShipCombatable.ContractDefinition;

namespace PirateNationContracts.ShipCombatable
{
    public partial class ShipCombatableService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, ShipCombatableDeployment shipCombatableDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<ShipCombatableDeployment>().SendRequestAndWaitForReceiptAsync(shipCombatableDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, ShipCombatableDeployment shipCombatableDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<ShipCombatableDeployment>().SendRequestAsync(shipCombatableDeployment);
        }

        public static async Task<ShipCombatableService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, ShipCombatableDeployment shipCombatableDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, shipCombatableDeployment, cancellationTokenSource);
            return new ShipCombatableService(web3, receipt.ContractAddress);
        }
        ...
        public ShipCombatableService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
