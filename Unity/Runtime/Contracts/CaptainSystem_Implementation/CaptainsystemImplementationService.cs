...
using PirateNationContracts.CaptainSystem_Implementation.ContractDefinition;

namespace PirateNationContracts.CaptainSystem_Implementation
{
    public partial class CaptainsystemImplementationService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, CaptainsystemImplementationDeployment captainsystemImplementationDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<CaptainsystemImplementationDeployment>().SendRequestAndWaitForReceiptAsync(captainsystemImplementationDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, CaptainsystemImplementationDeployment captainsystemImplementationDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<CaptainsystemImplementationDeployment>().SendRequestAsync(captainsystemImplementationDeployment);
        }

        public static async Task<CaptainsystemImplementationService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, CaptainsystemImplementationDeployment captainsystemImplementationDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, captainsystemImplementationDeployment, cancellationTokenSource);
            return new CaptainsystemImplementationService(web3, receipt.ContractAddress);
        }
        ...
        public CaptainsystemImplementationService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
