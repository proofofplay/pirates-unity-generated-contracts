...
using PirateNationContracts.AchievementTokenURIHandler_Implementation.ContractDefinition;

namespace PirateNationContracts.AchievementTokenURIHandler_Implementation
{
    public partial class AchievementtokenurihandlerImplementationService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, AchievementtokenurihandlerImplementationDeployment achievementtokenurihandlerImplementationDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<AchievementtokenurihandlerImplementationDeployment>().SendRequestAndWaitForReceiptAsync(achievementtokenurihandlerImplementationDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, AchievementtokenurihandlerImplementationDeployment achievementtokenurihandlerImplementationDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<AchievementtokenurihandlerImplementationDeployment>().SendRequestAsync(achievementtokenurihandlerImplementationDeployment);
        }

        public static async Task<AchievementtokenurihandlerImplementationService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, AchievementtokenurihandlerImplementationDeployment achievementtokenurihandlerImplementationDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, achievementtokenurihandlerImplementationDeployment, cancellationTokenSource);
            return new AchievementtokenurihandlerImplementationService(web3, receipt.ContractAddress);
        }
        ...
        public AchievementtokenurihandlerImplementationService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
