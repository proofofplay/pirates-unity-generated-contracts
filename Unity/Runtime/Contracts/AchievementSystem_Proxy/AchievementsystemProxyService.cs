...
using PirateNationContracts.AchievementSystem_Proxy.ContractDefinition;

namespace PirateNationContracts.AchievementSystem_Proxy
{
    public partial class AchievementsystemProxyService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, AchievementsystemProxyDeployment achievementsystemProxyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<AchievementsystemProxyDeployment>().SendRequestAndWaitForReceiptAsync(achievementsystemProxyDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, AchievementsystemProxyDeployment achievementsystemProxyDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<AchievementsystemProxyDeployment>().SendRequestAsync(achievementsystemProxyDeployment);
        }

        public static async Task<AchievementsystemProxyService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, AchievementsystemProxyDeployment achievementsystemProxyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, achievementsystemProxyDeployment, cancellationTokenSource);
            return new AchievementsystemProxyService(web3, receipt.ContractAddress);
        }
        ...
        public AchievementsystemProxyService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
