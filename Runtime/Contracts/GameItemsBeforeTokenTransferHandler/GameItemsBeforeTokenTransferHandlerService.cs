...
using PirateNationContracts.GameItemsBeforeTokenTransferHandler.ContractDefinition;

namespace PirateNationContracts.GameItemsBeforeTokenTransferHandler
{
    public partial class GameItemsBeforeTokenTransferHandlerService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, GameItemsBeforeTokenTransferHandlerDeployment gameItemsBeforeTokenTransferHandlerDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<GameItemsBeforeTokenTransferHandlerDeployment>().SendRequestAndWaitForReceiptAsync(gameItemsBeforeTokenTransferHandlerDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, GameItemsBeforeTokenTransferHandlerDeployment gameItemsBeforeTokenTransferHandlerDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<GameItemsBeforeTokenTransferHandlerDeployment>().SendRequestAsync(gameItemsBeforeTokenTransferHandlerDeployment);
        }

        public static async Task<GameItemsBeforeTokenTransferHandlerService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, GameItemsBeforeTokenTransferHandlerDeployment gameItemsBeforeTokenTransferHandlerDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, gameItemsBeforeTokenTransferHandlerDeployment, cancellationTokenSource);
            return new GameItemsBeforeTokenTransferHandlerService(web3, receipt.ContractAddress);
        }
        ...
        public GameItemsBeforeTokenTransferHandlerService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
