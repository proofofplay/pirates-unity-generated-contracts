...
using PirateNationContracts.CooldownSystem.ContractDefinition;

namespace PirateNationContracts.CooldownSystem
{
    public partial class CooldownSystemService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, CooldownSystemDeployment cooldownSystemDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<CooldownSystemDeployment>().SendRequestAndWaitForReceiptAsync(cooldownSystemDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, CooldownSystemDeployment cooldownSystemDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<CooldownSystemDeployment>().SendRequestAsync(cooldownSystemDeployment);
        }

        public static async Task<CooldownSystemService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, CooldownSystemDeployment cooldownSystemDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, cooldownSystemDeployment, cancellationTokenSource);
            return new CooldownSystemService(web3, receipt.ContractAddress);
        }
        ...
        public CooldownSystemService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
