...
using PirateNationContracts.TraitsProvider_Proxy.ContractDefinition;

namespace PirateNationContracts.TraitsProvider_Proxy
{
    public partial class TraitsproviderProxyService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, TraitsproviderProxyDeployment traitsproviderProxyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<TraitsproviderProxyDeployment>().SendRequestAndWaitForReceiptAsync(traitsproviderProxyDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, TraitsproviderProxyDeployment traitsproviderProxyDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<TraitsproviderProxyDeployment>().SendRequestAsync(traitsproviderProxyDeployment);
        }

        public static async Task<TraitsproviderProxyService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, TraitsproviderProxyDeployment traitsproviderProxyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, traitsproviderProxyDeployment, cancellationTokenSource);
            return new TraitsproviderProxyService(web3, receipt.ContractAddress);
        }
        ...
        public TraitsproviderProxyService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
