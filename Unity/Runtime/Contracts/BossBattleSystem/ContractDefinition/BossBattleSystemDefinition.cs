...
namespace PirateNationContracts.BossBattleSystem.ContractDefinition
{
    ...
    {
        [Parameter("uint256", "battleEntity", 1, false )]
        public virtual BigInteger BattleEntity { get; set; }
    }
    ...
    public class BattlePendingEventDTOBase : IEventDTO
    {
        [Parameter("uint256", "battleEntity", 1, false )]
        public virtual BigInteger BattleEntity { get; set; }
        [Parameter("uint256", "attackerEntity", 2, false )]
        public virtual BigInteger AttackerEntity { get; set; }
        [Parameter("uint256", "defenderEntity", 3, false )]
    ...
    public partial class EndBattleEventDTO : EndBattleEventDTOBase { }

    [Event("EndBattle")]
    public class EndBattleEventDTOBase : IEventDTO
    {
        [Parameter("uint256", "battleEntity", 1, false )]
        public virtual BigInteger BattleEntity { get; set; }
        [Parameter("uint256", "shipEntity", 2, false )]
        public virtual BigInteger ShipEntity { get; set; }
        [Parameter("uint256", "bossEntity", 3, false )]
        public virtual BigInteger BossEntity { get; set; }
        [Parameter("uint256", "newShipHealth", 4, false )]
        public virtual BigInteger NewShipHealth { get; set; }
        [Parameter("uint256", "newBossHealth", 5, false )]
        public virtual BigInteger NewBossHealth { get; set; }
        [Parameter("uint256", "damageDealt", 6, false )]
        public virtual BigInteger DamageDealt { get; set; }
        [Parameter("uint256", "damageTaken", 7, false )]
        public virtual BigInteger DamageTaken { get; set; }
        [Parameter("bool", "isKillShot", 8, false )]
