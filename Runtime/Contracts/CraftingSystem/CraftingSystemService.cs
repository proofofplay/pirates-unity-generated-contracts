...
using PirateNationContracts.CraftingSystem.ContractDefinition;

namespace PirateNationContracts.CraftingSystem
{
    public partial class CraftingSystemService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, CraftingSystemDeployment craftingSystemDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, CraftingSystemDeployment craftingSystemDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<CraftingSystemDeployment>().SendRequestAsync(craftingSystemDeployment);
        }

        public static async Task<CraftingSystemService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, CraftingSystemDeployment craftingSystemDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public CraftingSystemService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
