...
using PirateNationContracts.PirateGameV1.ContractDefinition;

namespace PirateNationContracts.PirateGameV1
{
    public partial class PirateGameV1Service
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, PirateGameV1Deployment pirateGameV1Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<PirateGameV1Deployment>().SendRequestAndWaitForReceiptAsync(pirateGameV1Deployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, PirateGameV1Deployment pirateGameV1Deployment)
        {
            return web3.Eth.GetContractDeploymentHandler<PirateGameV1Deployment>().SendRequestAsync(pirateGameV1Deployment);
        }

        public static async Task<PirateGameV1Service> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, PirateGameV1Deployment pirateGameV1Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, pirateGameV1Deployment, cancellationTokenSource);
            return new PirateGameV1Service(web3, receipt.ContractAddress);
        }
        ...
        public PirateGameV1Service(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
