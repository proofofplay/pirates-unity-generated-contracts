...
namespace PirateNationContracts.ShipNFTTokenURIHandler.ContractDefinition
{
    ...
    public partial class ShipNFTTokenURIHandlerDeployment : ShipNFTTokenURIHandlerDeploymentBase
    {
        public ShipNFTTokenURIHandlerDeployment() : base(BYTECODE) { }
        public ShipNFTTokenURIHandlerDeployment(string byteCode) : base(byteCode) { }
    }

    public class ShipNFTTokenURIHandlerDeploymentBase : ContractDeploymentMessage
    {
        ...
        public ShipNFTTokenURIHandlerDeploymentBase() : base(BYTECODE) { }
        public ShipNFTTokenURIHandlerDeploymentBase(string byteCode) : base(byteCode) { }
