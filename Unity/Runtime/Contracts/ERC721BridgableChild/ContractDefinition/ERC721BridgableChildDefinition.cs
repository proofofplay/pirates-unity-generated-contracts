...
namespace SimpleStorage.ERC721BridgableChild.ContractDefinition
{


    public partial class ERC721BridgableChildDeployment : ERC721BridgableChildDeploymentBase
    {
        public ERC721BridgableChildDeployment() : base(BYTECODE) { }
        public ERC721BridgableChildDeployment(string byteCode) : base(byteCode) { }
    }

    public class ERC721BridgableChildDeploymentBase : ContractDeploymentMessage
    {
        public static string BYTECODE = "";
        public ERC721BridgableChildDeploymentBase() : base(BYTECODE) { }
        public ERC721BridgableChildDeploymentBase(string byteCode) : base(byteCode) { }

    }

    public partial class BATCH_LIMITFunction : BATCH_LIMITFunctionBase { }

    [Function("BATCH_LIMIT", "uint256")]
    public class BATCH_LIMITFunctionBase : FunctionMessage
    {
    ...
    public partial class EncodeTokenMetadataFunction : EncodeTokenMetadataFunctionBase { }

    [Function("encodeTokenMetadata", "bytes")]
    public class EncodeTokenMetadataFunctionBase : FunctionMessage
    {
    ...
    public partial class IsLockedFunction : IsLockedFunctionBase { }

    [Function("isLocked", "bool")]
    public class IsLockedFunctionBase : FunctionMessage
    {
        [Parameter("uint256", "tokenId", 1)]
        public virtual BigInteger TokenId { get; set; }
    }
    ...
    public partial class WithdrawBatchFunction : WithdrawBatchFunctionBase { }

    [Function("withdrawBatch")]
    public class WithdrawBatchFunctionBase : FunctionMessage
    {
        [Parameter("uint256[]", "tokenIds", 1)]
        public virtual List<BigInteger> TokenIds { get; set; }
    }

    public partial class WithdrawWithMetadataFunction : WithdrawWithMetadataFunctionBase { }

    [Function("withdrawWithMetadata")]
    public class WithdrawWithMetadataFunctionBase : FunctionMessage
    {
        [Parameter("uint256", "tokenId", 1)]
        public virtual BigInteger TokenId { get; set; }
    }
    ...
    public partial class DepositFromBridgeEventDTO : DepositFromBridgeEventDTOBase { }

    [Event("DepositFromBridge")]
    public class DepositFromBridgeEventDTOBase : IEventDTO
    {
    ...
    public partial class TransferWithMetadataEventDTO : TransferWithMetadataEventDTOBase { }

    [Event("TransferWithMetadata")]
    public class TransferWithMetadataEventDTOBase : IEventDTO
    {
        [Parameter("address", "from", 1, true )]
        public virtual string From { get; set; }
        [Parameter("address", "to", 2, true )]
        ...
        [Parameter("uint256", "tokenId", 3, true )]
        public virtual BigInteger TokenId { get; set; }
        [Parameter("bytes", "metaData", 4, false )]
        public virtual byte[] MetaData { get; set; }
    }

    public partial class BATCH_LIMITOutputDTO : BATCH_LIMITOutputDTOBase { }

    [FunctionOutput]
    public class BATCH_LIMITOutputDTOBase : IFunctionOutputDTO 
    {
        [Parameter("uint256", "", 1)]
    ...
    public partial class EncodeTokenMetadataOutputDTO : EncodeTokenMetadataOutputDTOBase { }

    [FunctionOutput]
    public class EncodeTokenMetadataOutputDTOBase : IFunctionOutputDTO 
    {
        [Parameter("bytes", "", 1)]
    ...
    public partial class IsLockedOutputDTO : IsLockedOutputDTOBase { }

    [FunctionOutput]
    public class IsLockedOutputDTOBase : IFunctionOutputDTO 
    {
        [Parameter("bool", "", 1)]
        public virtual bool ReturnValue1 { get; set; }
    }
