...
using PirateNationContracts.TokenTemplateSystem_Proxy.ContractDefinition;

namespace PirateNationContracts.TokenTemplateSystem_Proxy
{
    public partial class TokentemplatesystemProxyService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, TokentemplatesystemProxyDeployment tokentemplatesystemProxyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<TokentemplatesystemProxyDeployment>().SendRequestAndWaitForReceiptAsync(tokentemplatesystemProxyDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, TokentemplatesystemProxyDeployment tokentemplatesystemProxyDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<TokentemplatesystemProxyDeployment>().SendRequestAsync(tokentemplatesystemProxyDeployment);
        }

        public static async Task<TokentemplatesystemProxyService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, TokentemplatesystemProxyDeployment tokentemplatesystemProxyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, tokentemplatesystemProxyDeployment, cancellationTokenSource);
            return new TokentemplatesystemProxyService(web3, receipt.ContractAddress);
        }
        ...
        public TokentemplatesystemProxyService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
