...
using PirateNationContracts.GameNFTBeforeTokenTransferHandler_Implementation.ContractDefinition;

namespace PirateNationContracts.GameNFTBeforeTokenTransferHandler_Implementation
{
    public partial class GamenftbeforetokentransferhandlerImplementationService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, GamenftbeforetokentransferhandlerImplementationDeployment gamenftbeforetokentransferhandlerImplementationDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<GamenftbeforetokentransferhandlerImplementationDeployment>().SendRequestAndWaitForReceiptAsync(gamenftbeforetokentransferhandlerImplementationDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, GamenftbeforetokentransferhandlerImplementationDeployment gamenftbeforetokentransferhandlerImplementationDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<GamenftbeforetokentransferhandlerImplementationDeployment>().SendRequestAsync(gamenftbeforetokentransferhandlerImplementationDeployment);
        }

        public static async Task<GamenftbeforetokentransferhandlerImplementationService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, GamenftbeforetokentransferhandlerImplementationDeployment gamenftbeforetokentransferhandlerImplementationDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, gamenftbeforetokentransferhandlerImplementationDeployment, cancellationTokenSource);
            return new GamenftbeforetokentransferhandlerImplementationService(web3, receipt.ContractAddress);
        }
        ...
        public GamenftbeforetokentransferhandlerImplementationService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
