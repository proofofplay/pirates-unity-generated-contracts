...
using PirateNationContracts.AchievementNFTTokenURIHandler_Implementation.ContractDefinition;

namespace PirateNationContracts.AchievementNFTTokenURIHandler_Implementation
{
    public partial class AchievementnfttokenurihandlerImplementationService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, AchievementnfttokenurihandlerImplementationDeployment achievementnfttokenurihandlerImplementationDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<AchievementnfttokenurihandlerImplementationDeployment>().SendRequestAndWaitForReceiptAsync(achievementnfttokenurihandlerImplementationDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, AchievementnfttokenurihandlerImplementationDeployment achievementnfttokenurihandlerImplementationDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<AchievementnfttokenurihandlerImplementationDeployment>().SendRequestAsync(achievementnfttokenurihandlerImplementationDeployment);
        }

        public static async Task<AchievementnfttokenurihandlerImplementationService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, AchievementnfttokenurihandlerImplementationDeployment achievementnfttokenurihandlerImplementationDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, achievementnfttokenurihandlerImplementationDeployment, cancellationTokenSource);
            return new AchievementnfttokenurihandlerImplementationService(web3, receipt.ContractAddress);
        }
        ...
        public AchievementnfttokenurihandlerImplementationService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
