...
using PirateNationContracts.ShipCombatable_Proxy.ContractDefinition;

namespace PirateNationContracts.ShipCombatable_Proxy
{
    public partial class ShipcombatableProxyService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, ShipcombatableProxyDeployment shipcombatableProxyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<ShipcombatableProxyDeployment>().SendRequestAndWaitForReceiptAsync(shipcombatableProxyDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, ShipcombatableProxyDeployment shipcombatableProxyDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<ShipcombatableProxyDeployment>().SendRequestAsync(shipcombatableProxyDeployment);
        }

        public static async Task<ShipcombatableProxyService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, ShipcombatableProxyDeployment shipcombatableProxyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, shipcombatableProxyDeployment, cancellationTokenSource);
            return new ShipcombatableProxyService(web3, receipt.ContractAddress);
        }
        ...
        public ShipcombatableProxyService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
