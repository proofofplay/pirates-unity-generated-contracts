...
using PirateNationContracts.ShipNFTBeforeTokenTransferHandler_Proxy.ContractDefinition;

namespace PirateNationContracts.ShipNFTBeforeTokenTransferHandler_Proxy
{
    public partial class ShipnftbeforetokentransferhandlerProxyService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, ShipnftbeforetokentransferhandlerProxyDeployment shipnftbeforetokentransferhandlerProxyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<ShipnftbeforetokentransferhandlerProxyDeployment>().SendRequestAndWaitForReceiptAsync(shipnftbeforetokentransferhandlerProxyDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, ShipnftbeforetokentransferhandlerProxyDeployment shipnftbeforetokentransferhandlerProxyDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<ShipnftbeforetokentransferhandlerProxyDeployment>().SendRequestAsync(shipnftbeforetokentransferhandlerProxyDeployment);
        }

        public static async Task<ShipnftbeforetokentransferhandlerProxyService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, ShipnftbeforetokentransferhandlerProxyDeployment shipnftbeforetokentransferhandlerProxyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, shipnftbeforetokentransferhandlerProxyDeployment, cancellationTokenSource);
            return new ShipnftbeforetokentransferhandlerProxyService(web3, receipt.ContractAddress);
        }
        ...
        public ShipnftbeforetokentransferhandlerProxyService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
