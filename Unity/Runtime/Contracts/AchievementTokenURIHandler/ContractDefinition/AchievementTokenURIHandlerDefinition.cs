...
namespace PirateNationContracts.AchievementTokenURIHandler.ContractDefinition
{


    public partial class AchievementTokenURIHandlerDeployment : AchievementTokenURIHandlerDeploymentBase
    {
        public AchievementTokenURIHandlerDeployment() : base(BYTECODE) { }
        public AchievementTokenURIHandlerDeployment(string byteCode) : base(byteCode) { }
    }

    public class AchievementTokenURIHandlerDeploymentBase : ContractDeploymentMessage
    {
        ...
        public AchievementTokenURIHandlerDeploymentBase() : base(BYTECODE) { }
        public AchievementTokenURIHandlerDeploymentBase(string byteCode) : base(byteCode) { }
