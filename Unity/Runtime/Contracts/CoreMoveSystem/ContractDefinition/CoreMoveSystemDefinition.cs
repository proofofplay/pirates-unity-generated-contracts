...
namespace PirateNationContracts.CoreMoveSystem.ContractDefinition
{


    public partial class CoreMoveSystemDeployment : CoreMoveSystemDeploymentBase
    {
        public CoreMoveSystemDeployment() : base(BYTECODE) { }
        public CoreMoveSystemDeployment(string byteCode) : base(byteCode) { }
    }

    public class CoreMoveSystemDeploymentBase : ContractDeploymentMessage
    {
        ...
        public CoreMoveSystemDeploymentBase() : base(BYTECODE) { }
        public CoreMoveSystemDeploymentBase(string byteCode) : base(byteCode) { }
