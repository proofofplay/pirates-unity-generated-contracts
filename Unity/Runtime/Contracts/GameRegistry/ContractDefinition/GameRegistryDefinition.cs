...
namespace PirateNationContracts.GameRegistry.ContractDefinition
{


    public partial class GameRegistryDeployment : GameRegistryDeploymentBase
    {
        public GameRegistryDeployment() : base(BYTECODE) { }
        public GameRegistryDeployment(string byteCode) : base(byteCode) { }
    }

    public class GameRegistryDeploymentBase : ContractDeploymentMessage
    {
        ...
        public GameRegistryDeploymentBase() : base(BYTECODE) { }
        public GameRegistryDeploymentBase(string byteCode) : base(byteCode) { }
