...
using PirateNationContracts.CoreMoveSystem.ContractDefinition;

namespace PirateNationContracts.CoreMoveSystem
{
    public partial class CoreMoveSystemService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, CoreMoveSystemDeployment coreMoveSystemDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<CoreMoveSystemDeployment>().SendRequestAndWaitForReceiptAsync(coreMoveSystemDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, CoreMoveSystemDeployment coreMoveSystemDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<CoreMoveSystemDeployment>().SendRequestAsync(coreMoveSystemDeployment);
        }

        public static async Task<CoreMoveSystemService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, CoreMoveSystemDeployment coreMoveSystemDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, coreMoveSystemDeployment, cancellationTokenSource);
            return new CoreMoveSystemService(web3, receipt.ContractAddress);
        }
        ...
        public CoreMoveSystemService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
