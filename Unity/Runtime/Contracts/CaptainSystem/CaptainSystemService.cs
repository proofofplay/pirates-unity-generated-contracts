...
using PirateNationContracts.CaptainSystem.ContractDefinition;

namespace PirateNationContracts.CaptainSystem
{
    public partial class CaptainSystemService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, CaptainSystemDeployment captainSystemDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<CaptainSystemDeployment>().SendRequestAndWaitForReceiptAsync(captainSystemDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, CaptainSystemDeployment captainSystemDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<CaptainSystemDeployment>().SendRequestAsync(captainSystemDeployment);
        }

        public static async Task<CaptainSystemService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, CaptainSystemDeployment captainSystemDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, captainSystemDeployment, cancellationTokenSource);
            return new CaptainSystemService(web3, receipt.ContractAddress);
        }
        ...
        public CaptainSystemService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
