...
using PirateNationContracts.AchievementNFTBeforeTokenTransferHandler_Proxy.ContractDefinition;

namespace PirateNationContracts.AchievementNFTBeforeTokenTransferHandler_Proxy
{
    public partial class AchievementnftbeforetokentransferhandlerProxyService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, AchievementnftbeforetokentransferhandlerProxyDeployment achievementnftbeforetokentransferhandlerProxyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<AchievementnftbeforetokentransferhandlerProxyDeployment>().SendRequestAndWaitForReceiptAsync(achievementnftbeforetokentransferhandlerProxyDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, AchievementnftbeforetokentransferhandlerProxyDeployment achievementnftbeforetokentransferhandlerProxyDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<AchievementnftbeforetokentransferhandlerProxyDeployment>().SendRequestAsync(achievementnftbeforetokentransferhandlerProxyDeployment);
        }

        public static async Task<AchievementnftbeforetokentransferhandlerProxyService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, AchievementnftbeforetokentransferhandlerProxyDeployment achievementnftbeforetokentransferhandlerProxyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, achievementnftbeforetokentransferhandlerProxyDeployment, cancellationTokenSource);
            return new AchievementnftbeforetokentransferhandlerProxyService(web3, receipt.ContractAddress);
        }
        ...
        public AchievementnftbeforetokentransferhandlerProxyService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
