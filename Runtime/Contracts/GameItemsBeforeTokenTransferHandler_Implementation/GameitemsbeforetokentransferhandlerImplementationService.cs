...
using PirateNationContracts.GameItemsBeforeTokenTransferHandler_Implementation.ContractDefinition;

namespace PirateNationContracts.GameItemsBeforeTokenTransferHandler_Implementation
{
    public partial class GameitemsbeforetokentransferhandlerImplementationService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, GameitemsbeforetokentransferhandlerImplementationDeployment gameitemsbeforetokentransferhandlerImplementationDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<GameitemsbeforetokentransferhandlerImplementationDeployment>().SendRequestAndWaitForReceiptAsync(gameitemsbeforetokentransferhandlerImplementationDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, GameitemsbeforetokentransferhandlerImplementationDeployment gameitemsbeforetokentransferhandlerImplementationDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<GameitemsbeforetokentransferhandlerImplementationDeployment>().SendRequestAsync(gameitemsbeforetokentransferhandlerImplementationDeployment);
        }

        public static async Task<GameitemsbeforetokentransferhandlerImplementationService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, GameitemsbeforetokentransferhandlerImplementationDeployment gameitemsbeforetokentransferhandlerImplementationDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, gameitemsbeforetokentransferhandlerImplementationDeployment, cancellationTokenSource);
            return new GameitemsbeforetokentransferhandlerImplementationService(web3, receipt.ContractAddress);
        }
        ...
        public GameitemsbeforetokentransferhandlerImplementationService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
