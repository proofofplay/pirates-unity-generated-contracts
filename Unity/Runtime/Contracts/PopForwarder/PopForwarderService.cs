...
using PirateNationContracts.PopForwarder.ContractDefinition;

namespace PirateNationContracts.PopForwarder
{
    public partial class PopForwarderService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, PopForwarderDeployment popForwarderDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<PopForwarderDeployment>().SendRequestAndWaitForReceiptAsync(popForwarderDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, PopForwarderDeployment popForwarderDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<PopForwarderDeployment>().SendRequestAsync(popForwarderDeployment);
        }

        public static async Task<PopForwarderService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, PopForwarderDeployment popForwarderDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, popForwarderDeployment, cancellationTokenSource);
            return new PopForwarderService(web3, receipt.ContractAddress);
        }
        ...
        public PopForwarderService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
