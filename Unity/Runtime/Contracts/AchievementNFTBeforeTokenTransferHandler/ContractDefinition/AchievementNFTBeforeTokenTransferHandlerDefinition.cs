...
namespace PirateNationContracts.AchievementNFTBeforeTokenTransferHandler.ContractDefinition
{


    public partial class AchievementNFTBeforeTokenTransferHandlerDeployment : AchievementNFTBeforeTokenTransferHandlerDeploymentBase
    {
        public AchievementNFTBeforeTokenTransferHandlerDeployment() : base(BYTECODE) { }
        public AchievementNFTBeforeTokenTransferHandlerDeployment(string byteCode) : base(byteCode) { }
    }

    public class AchievementNFTBeforeTokenTransferHandlerDeploymentBase : ContractDeploymentMessage
    {
        ...
        public AchievementNFTBeforeTokenTransferHandlerDeploymentBase() : base(BYTECODE) { }
        public AchievementNFTBeforeTokenTransferHandlerDeploymentBase(string byteCode) : base(byteCode) { }
