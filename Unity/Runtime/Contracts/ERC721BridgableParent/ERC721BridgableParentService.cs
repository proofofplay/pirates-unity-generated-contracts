...
using SimpleStorage.ERC721BridgableParent.ContractDefinition;

namespace SimpleStorage.ERC721BridgableParent
{
    public partial class ERC721BridgableParentService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, ERC721BridgableParentDeployment eRC721BridgableParentDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<ERC721BridgableParentDeployment>().SendRequestAndWaitForReceiptAsync(eRC721BridgableParentDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, ERC721BridgableParentDeployment eRC721BridgableParentDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<ERC721BridgableParentDeployment>().SendRequestAsync(eRC721BridgableParentDeployment);
        }

        public static async Task<ERC721BridgableParentService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, ERC721BridgableParentDeployment eRC721BridgableParentDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, eRC721BridgableParentDeployment, cancellationTokenSource);
            return new ERC721BridgableParentService(web3, receipt.ContractAddress);
        }
        ...
        public ERC721BridgableParentService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
