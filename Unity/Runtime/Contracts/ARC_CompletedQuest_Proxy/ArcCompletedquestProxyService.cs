...
using PirateNationContracts.ARC_CompletedQuest_Proxy.ContractDefinition;

namespace PirateNationContracts.ARC_CompletedQuest_Proxy
{
    public partial class ArcCompletedquestProxyService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, ArcCompletedquestProxyDeployment arcCompletedquestProxyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<ArcCompletedquestProxyDeployment>().SendRequestAndWaitForReceiptAsync(arcCompletedquestProxyDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, ArcCompletedquestProxyDeployment arcCompletedquestProxyDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<ArcCompletedquestProxyDeployment>().SendRequestAsync(arcCompletedquestProxyDeployment);
        }

        public static async Task<ArcCompletedquestProxyService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, ArcCompletedquestProxyDeployment arcCompletedquestProxyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, arcCompletedquestProxyDeployment, cancellationTokenSource);
            return new ArcCompletedquestProxyService(web3, receipt.ContractAddress);
        }
        ...
        public ArcCompletedquestProxyService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
