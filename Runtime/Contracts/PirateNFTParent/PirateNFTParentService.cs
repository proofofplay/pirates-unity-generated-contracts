...
using SimpleStorage.PirateNFTParent.ContractDefinition;

namespace SimpleStorage.PirateNFTParent
{
    public partial class PirateNFTParentService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, PirateNFTParentDeployment pirateNFTParentDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<PirateNFTParentDeployment>().SendRequestAndWaitForReceiptAsync(pirateNFTParentDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, PirateNFTParentDeployment pirateNFTParentDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<PirateNFTParentDeployment>().SendRequestAsync(pirateNFTParentDeployment);
        }

        public static async Task<PirateNFTParentService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, PirateNFTParentDeployment pirateNFTParentDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, pirateNFTParentDeployment, cancellationTokenSource);
            return new PirateNFTParentService(web3, receipt.ContractAddress);
        }
        ...
        public PirateNFTParentService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
        ...
        public Task<byte[]> PREDICATE_ROLEQueryAsync(PREDICATE_ROLEFunction pREDICATE_ROLEFunction, BlockParameter blockParameter = null)
        {
            return ContractHandler.QueryAsync<PREDICATE_ROLEFunction, byte[]>(pREDICATE_ROLEFunction, blockParameter);
        }

        
        public Task<byte[]> PREDICATE_ROLEQueryAsync(BlockParameter blockParameter = null)
        {
            return ContractHandler.QueryAsync<PREDICATE_ROLEFunction, byte[]>(null, blockParameter);
        }
        ...
        public Task<bool> MetadataEnabledQueryAsync(MetadataEnabledFunction metadataEnabledFunction, BlockParameter blockParameter = null)
        {
            return ContractHandler.QueryAsync<MetadataEnabledFunction, bool>(metadataEnabledFunction, blockParameter);
        }

        
        public Task<bool> MetadataEnabledQueryAsync(BlockParameter blockParameter = null)
        {
            return ContractHandler.QueryAsync<MetadataEnabledFunction, bool>(null, blockParameter);
        }
        ...
        public Task<string> MintRequestAsync(string to, BigInteger tokenId)
        {
        ...
        public Task<TransactionReceipt> MintRequestAndWaitForReceiptAsync(string to, BigInteger tokenId, CancellationTokenSource cancellationToken = null)
        {
            var mintFunction = new MintFunction();
                mintFunction.To = to;
                mintFunction.TokenId = tokenId;
        ...
        public Task<string> MintRequestAsync(string to, BigInteger tokenId, byte[] metadata)
        {
            var mint1Function = new Mint1Function();
                mint1Function.To = to;
                mint1Function.TokenId = tokenId;
                mint1Function.Metadata = metadata;
            
             return ContractHandler.SendRequestAsync(mint1Function);
        }

        public Task<TransactionReceipt> MintRequestAndWaitForReceiptAsync(string to, BigInteger tokenId, byte[] metadata, CancellationTokenSource cancellationToken = null)
        {
            var mint1Function = new Mint1Function();
                mint1Function.To = to;
                mint1Function.TokenId = tokenId;
        ...
        public Task<string> MintTESTRequestAsync(MintTESTFunction mintTESTFunction)
        {
             return ContractHandler.SendRequestAsync(mintTESTFunction);
        }

        public Task<TransactionReceipt> MintTESTRequestAndWaitForReceiptAsync(MintTESTFunction mintTESTFunction, CancellationTokenSource cancellationToken = null)
        {
             return ContractHandler.SendRequestAndWaitForReceiptAsync(mintTESTFunction, cancellationToken);
        }

        public Task<string> MintTESTRequestAsync(BigInteger tokenId)
        {
            var mintTESTFunction = new MintTESTFunction();
                mintTESTFunction.TokenId = tokenId;
            
             return ContractHandler.SendRequestAsync(mintTESTFunction);
        }

        public Task<TransactionReceipt> MintTESTRequestAndWaitForReceiptAsync(BigInteger tokenId, CancellationTokenSource cancellationToken = null)
        {
            var mintTESTFunction = new MintTESTFunction();
                mintTESTFunction.TokenId = tokenId;
        ...
        public Task<string> SetMetadataEnabledRequestAsync(SetMetadataEnabledFunction setMetadataEnabledFunction)
        {
             return ContractHandler.SendRequestAsync(setMetadataEnabledFunction);
        }

        public Task<TransactionReceipt> SetMetadataEnabledRequestAndWaitForReceiptAsync(SetMetadataEnabledFunction setMetadataEnabledFunction, CancellationTokenSource cancellationToken = null)
        {
             return ContractHandler.SendRequestAndWaitForReceiptAsync(setMetadataEnabledFunction, cancellationToken);
        }

        public Task<string> SetMetadataEnabledRequestAsync(bool enabled)
        {
            var setMetadataEnabledFunction = new SetMetadataEnabledFunction();
                setMetadataEnabledFunction.Enabled = enabled;
            
             return ContractHandler.SendRequestAsync(setMetadataEnabledFunction);
        }

        public Task<TransactionReceipt> SetMetadataEnabledRequestAndWaitForReceiptAsync(bool enabled, CancellationTokenSource cancellationToken = null)
        {
            var setMetadataEnabledFunction = new SetMetadataEnabledFunction();
                setMetadataEnabledFunction.Enabled = enabled;
        ...
        public Task<string> SetTokenMetadataRequestAsync(SetTokenMetadataFunction setTokenMetadataFunction)
        {
             return ContractHandler.SendRequestAsync(setTokenMetadataFunction);
        }

        public Task<TransactionReceipt> SetTokenMetadataRequestAndWaitForReceiptAsync(SetTokenMetadataFunction setTokenMetadataFunction, CancellationTokenSource cancellationToken = null)
        {
             return ContractHandler.SendRequestAndWaitForReceiptAsync(setTokenMetadataFunction, cancellationToken);
        }

        public Task<string> SetTokenMetadataRequestAsync(BigInteger tokenId, byte[] data)
        {
            var setTokenMetadataFunction = new SetTokenMetadataFunction();
                setTokenMetadataFunction.TokenId = tokenId;
                setTokenMetadataFunction.Data = data;
            
             return ContractHandler.SendRequestAsync(setTokenMetadataFunction);
        }

        public Task<TransactionReceipt> SetTokenMetadataRequestAndWaitForReceiptAsync(BigInteger tokenId, byte[] data, CancellationTokenSource cancellationToken = null)
        {
            var setTokenMetadataFunction = new SetTokenMetadataFunction();
                setTokenMetadataFunction.TokenId = tokenId;
                setTokenMetadataFunction.Data = data;
