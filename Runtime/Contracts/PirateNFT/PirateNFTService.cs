...
using PirateNationContracts.PirateNFT.ContractDefinition;

namespace PirateNationContracts.PirateNFT
{
    public partial class PirateNFTService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, PirateNFTDeployment pirateNFTDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<PirateNFTDeployment>().SendRequestAndWaitForReceiptAsync(pirateNFTDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, PirateNFTDeployment pirateNFTDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<PirateNFTDeployment>().SendRequestAsync(pirateNFTDeployment);
        }

        public static async Task<PirateNFTService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, PirateNFTDeployment pirateNFTDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, pirateNFTDeployment, cancellationTokenSource);
            return new PirateNFTService(web3, receipt.ContractAddress);
        }
        ...
        public PirateNFTService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
