...
using PirateNationContracts.BossCombatable.ContractDefinition;

namespace PirateNationContracts.BossCombatable
{
    public partial class BossCombatableService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, BossCombatableDeployment bossCombatableDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<BossCombatableDeployment>().SendRequestAndWaitForReceiptAsync(bossCombatableDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, BossCombatableDeployment bossCombatableDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<BossCombatableDeployment>().SendRequestAsync(bossCombatableDeployment);
        }

        public static async Task<BossCombatableService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, BossCombatableDeployment bossCombatableDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, bossCombatableDeployment, cancellationTokenSource);
            return new BossCombatableService(web3, receipt.ContractAddress);
        }
        ...
        public BossCombatableService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
