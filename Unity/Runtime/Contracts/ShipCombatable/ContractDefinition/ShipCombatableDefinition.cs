...
namespace PirateNationContracts.ShipCombatable.ContractDefinition
{


    public partial class ShipCombatableDeployment : ShipCombatableDeploymentBase
    {
        public ShipCombatableDeployment() : base(BYTECODE) { }
        public ShipCombatableDeployment(string byteCode) : base(byteCode) { }
    }

    public class ShipCombatableDeploymentBase : ContractDeploymentMessage
    {
        ...
        public ShipCombatableDeploymentBase() : base(BYTECODE) { }
        public ShipCombatableDeploymentBase(string byteCode) : base(byteCode) { }
    ...
    public partial class MissingPirateEntityError : MissingPirateEntityErrorBase { }

    [Error("MissingPirateEntity")]
    public class MissingPirateEntityErrorBase : IErrorDTO
    {
        [Parameter("uint256", "entityId", 1)]
        public virtual BigInteger EntityId { get; set; }
    }
