...
namespace PirateNationContracts.LockingSystem.ContractDefinition
{
    ...
    public partial class LockingSystemDeployment : LockingSystemDeploymentBase
    {
        public LockingSystemDeployment() : base(BYTECODE) { }
        public LockingSystemDeployment(string byteCode) : base(byteCode) { }
    }

    public class LockingSystemDeploymentBase : ContractDeploymentMessage
    {
        ...
        public LockingSystemDeploymentBase() : base(BYTECODE) { }
        public LockingSystemDeploymentBase(string byteCode) : base(byteCode) { }
