...
using PirateNationContracts.BossSpawn.ContractDefinition;

namespace PirateNationContracts.BossSpawn
{
    public partial class BossSpawnService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, BossSpawnDeployment bossSpawnDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<BossSpawnDeployment>().SendRequestAndWaitForReceiptAsync(bossSpawnDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, BossSpawnDeployment bossSpawnDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<BossSpawnDeployment>().SendRequestAsync(bossSpawnDeployment);
        }

        public static async Task<BossSpawnService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, BossSpawnDeployment bossSpawnDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, bossSpawnDeployment, cancellationTokenSource);
            return new BossSpawnService(web3, receipt.ContractAddress);
        }
        ...
        public BossSpawnService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
