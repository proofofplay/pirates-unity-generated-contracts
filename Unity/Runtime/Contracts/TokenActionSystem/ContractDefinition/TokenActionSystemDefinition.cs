...
namespace PirateNationContracts.TokenActionSystem.ContractDefinition
{


    public partial class TokenActionSystemDeployment : TokenActionSystemDeploymentBase
    {
        public TokenActionSystemDeployment() : base(BYTECODE) { }
        public TokenActionSystemDeployment(string byteCode) : base(byteCode) { }
    }

    public class TokenActionSystemDeploymentBase : ContractDeploymentMessage
    {
        ...
        public TokenActionSystemDeploymentBase() : base(BYTECODE) { }
        public TokenActionSystemDeploymentBase(string byteCode) : base(byteCode) { }
