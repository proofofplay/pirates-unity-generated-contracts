...
using PirateNationContracts.GameGlobals.ContractDefinition;

namespace PirateNationContracts.GameGlobals
{
    public partial class GameGlobalsService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, GameGlobalsDeployment gameGlobalsDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<GameGlobalsDeployment>().SendRequestAndWaitForReceiptAsync(gameGlobalsDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, GameGlobalsDeployment gameGlobalsDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<GameGlobalsDeployment>().SendRequestAsync(gameGlobalsDeployment);
        }

        public static async Task<GameGlobalsService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, GameGlobalsDeployment gameGlobalsDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, gameGlobalsDeployment, cancellationTokenSource);
            return new GameGlobalsService(web3, receipt.ContractAddress);
        }
        ...
        public GameGlobalsService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
