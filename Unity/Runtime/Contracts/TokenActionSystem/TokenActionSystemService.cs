...
using PirateNationContracts.TokenActionSystem.ContractDefinition;

namespace PirateNationContracts.TokenActionSystem
{
    public partial class TokenActionSystemService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, TokenActionSystemDeployment tokenActionSystemDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<TokenActionSystemDeployment>().SendRequestAndWaitForReceiptAsync(tokenActionSystemDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, TokenActionSystemDeployment tokenActionSystemDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<TokenActionSystemDeployment>().SendRequestAsync(tokenActionSystemDeployment);
        }

        public static async Task<TokenActionSystemService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, TokenActionSystemDeployment tokenActionSystemDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, tokenActionSystemDeployment, cancellationTokenSource);
            return new TokenActionSystemService(web3, receipt.ContractAddress);
        }
        ...
        public TokenActionSystemService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
