...
using PirateNationContracts.CountingSystem.ContractDefinition;

namespace PirateNationContracts.CountingSystem
{
    public partial class CountingSystemService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, CountingSystemDeployment countingSystemDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<CountingSystemDeployment>().SendRequestAndWaitForReceiptAsync(countingSystemDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, CountingSystemDeployment countingSystemDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<CountingSystemDeployment>().SendRequestAsync(countingSystemDeployment);
        }

        public static async Task<CountingSystemService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, CountingSystemDeployment countingSystemDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, countingSystemDeployment, cancellationTokenSource);
            return new CountingSystemService(web3, receipt.ContractAddress);
        }
        ...
        public CountingSystemService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
