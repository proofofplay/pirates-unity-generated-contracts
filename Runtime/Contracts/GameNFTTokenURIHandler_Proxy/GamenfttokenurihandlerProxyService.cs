...
using PirateNationContracts.GameNFTTokenURIHandler_Proxy.ContractDefinition;

namespace PirateNationContracts.GameNFTTokenURIHandler_Proxy
{
    public partial class GamenfttokenurihandlerProxyService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, GamenfttokenurihandlerProxyDeployment gamenfttokenurihandlerProxyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<GamenfttokenurihandlerProxyDeployment>().SendRequestAndWaitForReceiptAsync(gamenfttokenurihandlerProxyDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, GamenfttokenurihandlerProxyDeployment gamenfttokenurihandlerProxyDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<GamenfttokenurihandlerProxyDeployment>().SendRequestAsync(gamenfttokenurihandlerProxyDeployment);
        }

        public static async Task<GamenfttokenurihandlerProxyService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, GamenfttokenurihandlerProxyDeployment gamenfttokenurihandlerProxyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, gamenfttokenurihandlerProxyDeployment, cancellationTokenSource);
            return new GamenfttokenurihandlerProxyService(web3, receipt.ContractAddress);
        }
        ...
        public GamenfttokenurihandlerProxyService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
