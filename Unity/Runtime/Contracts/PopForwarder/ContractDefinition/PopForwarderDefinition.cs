...
namespace PirateNationContracts.PopForwarder.ContractDefinition
{


    public partial class PopForwarderDeployment : PopForwarderDeploymentBase
    {
        public PopForwarderDeployment() : base(BYTECODE) { }
        public PopForwarderDeployment(string byteCode) : base(byteCode) { }
    }

    public class PopForwarderDeploymentBase : ContractDeploymentMessage
    {
        ...
        public PopForwarderDeploymentBase() : base(BYTECODE) { }
        public PopForwarderDeploymentBase(string byteCode) : base(byteCode) { }
