...
using PirateNationContracts.TA_GiveEnergy.ContractDefinition;

namespace PirateNationContracts.TA_GiveEnergy
{
    public partial class TaGiveenergyService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, TaGiveenergyDeployment taGiveenergyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<TaGiveenergyDeployment>().SendRequestAndWaitForReceiptAsync(taGiveenergyDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, TaGiveenergyDeployment taGiveenergyDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<TaGiveenergyDeployment>().SendRequestAsync(taGiveenergyDeployment);
        }

        public static async Task<TaGiveenergyService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, TaGiveenergyDeployment taGiveenergyDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, taGiveenergyDeployment, cancellationTokenSource);
            return new TaGiveenergyService(web3, receipt.ContractAddress);
        }
        ...
        public TaGiveenergyService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
