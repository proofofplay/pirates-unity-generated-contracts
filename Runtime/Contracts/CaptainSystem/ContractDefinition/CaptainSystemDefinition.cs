...
namespace PirateNationContracts.CaptainSystem.ContractDefinition
{


    public partial class CaptainSystemDeployment : CaptainSystemDeploymentBase
    {
        public CaptainSystemDeployment() : base(BYTECODE) { }
        public CaptainSystemDeployment(string byteCode) : base(byteCode) { }
    }

    public class CaptainSystemDeploymentBase : ContractDeploymentMessage
    {
        ...
        public CaptainSystemDeploymentBase() : base(BYTECODE) { }
        public CaptainSystemDeploymentBase(string byteCode) : base(byteCode) { }
