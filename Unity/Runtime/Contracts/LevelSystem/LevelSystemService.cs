...
using PirateNationContracts.LevelSystem.ContractDefinition;

namespace PirateNationContracts.LevelSystem
{
    public partial class LevelSystemService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, LevelSystemDeployment levelSystemDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<LevelSystemDeployment>().SendRequestAndWaitForReceiptAsync(levelSystemDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, LevelSystemDeployment levelSystemDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<LevelSystemDeployment>().SendRequestAsync(levelSystemDeployment);
        }

        public static async Task<LevelSystemService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, LevelSystemDeployment levelSystemDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, levelSystemDeployment, cancellationTokenSource);
            return new LevelSystemService(web3, receipt.ContractAddress);
        }
        ...
        public LevelSystemService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
